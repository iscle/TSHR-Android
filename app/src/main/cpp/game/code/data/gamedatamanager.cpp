...
void
GameDataManager::LoadGame(unsigned int slot, GameDataLoadCallback *callback,
...
#else
    saveGameInfo->FormatDisplay(saveGameInfo->m_displayFilename,
                                sizeof(saveGameInfo->m_displayFilename));
#endif
...
bool
GameDataManager::DoesSaveGameExist(IRadDrive *pDrive, bool check_valid/* = true*/,
                                   bool forAllSlots) {
    bool saveGameExists = false;

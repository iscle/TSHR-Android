...
public:
    ...
    short GetPersistentObjectID(
            void); // This is a level based object not associated with a particular sector.
...
inline PersistentWorldManager *
GetPersistentWorldManager() { return PersistentWorldManager::GetInstance(); }

...
=============================================================================
*/
int Road::GetRoadSegmentAtPoint(const rmt::Vector &point, RoadSegment **ppOutRoadSegment, float &in,
...
*/
bool
Road::IsPointInRoadSegment(int index, const rmt::Vector &point, float &in, float &lateral) const {

...
public:
    ...
    void
    SetMissionComplete(RenderEnums::LevelEnum level, char *name, bool completed_secondary_objective,
                       int seconds = -1);
    ...
    unsigned char *
    GetPersistentObjectStates(void) { return &(mCharacterSheet.mPersistentObjectStates[0]); }

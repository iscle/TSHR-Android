...
private:
    ...
    */
    ...
    static void
    SetDemoLoopTime(int argc, char **argv);  //This isn't really dependant on the mission.
...
inline MissionScriptLoader *
GetMissionScriptLoader() { return (MissionScriptLoader::GetInstance()); }

...
public:
    ...
    int BindReward(char *name, char *filename, Reward::eRewardType rtype, Reward::eQuestType qtype,
                   int level);
    ...
    int AddMerchandise(char *name, char *filename, Reward::eRewardType rtype, int level, int cost,
                       Merchandise::eSellerType sellerType);
    ...
    int SetCarAttributes(char *carname, float speed, float acceleration, float toughness,
                         float stability);

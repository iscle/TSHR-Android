...
public:
    ...
    static CStateProp *
    CreateStateProp(CStatePropData *statePropData, unsigned int state = 0, tPose *pose = NULL);

    CStateProp(tAnimatedObject *animatedObject, CStatePropData *statePropData,

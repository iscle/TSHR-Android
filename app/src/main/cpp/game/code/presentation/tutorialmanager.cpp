...
void TutorialManager::HandleEvent(EventEnum id, void *pEventData) {
    ...
    switch (id) {
        ...
        default: {
            rAssertMsg(false,
                       "TutorialManager: why are we registered for messages we don't care about?");
            break;
        }
    }

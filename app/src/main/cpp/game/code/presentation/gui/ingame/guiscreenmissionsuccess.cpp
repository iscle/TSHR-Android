...
CGuiScreenMissionSuccess::CGuiScreenMissionSuccess
    ...
    Scrooby::Page *page = pScreen->GetPage("MissionLoad");
    rAssert(page != NULL);
    m_PattyAndSelmaTitle = page->GetText("PattyAndSelmaTitle");
    rAssert(m_PattyAndSelmaTitle != NULL);
    m_PattyAndSelmaTitle->SetTextMode(Scrooby::TEXT_WRAP);
    m_PattyAndSelmaInfo = page->GetText("PattyAndSelmaInfo");
    rAssert(m_PattyAndSelmaInfo != NULL);

            ...
            case STATE_MESSAGE_TRANSITION_IN: {
                ...
                if (m_elapsedTime < MESSAGE_TRANSITION_TIME) {
                    ...
                    if (m_hnrMessage->GetIndex() == MSG_HIT_N_RUN) {
                        ...
                        m_hnrMessage->RotateAboutCenter(
                                percentageDone * HNR_MESSAGE_BUSTED_TILT_ANGLE);
                        ...
                        GuiSFX::Projectile(m_hnrTicket,
                                           ...
                                           rmt::Vector(0, 0, 0),
                                           rmt::Vector((float) m_messageTranslateX,
                                                       (float) m_messageTranslateY, 0),
                                           true,
                                           0.0f);
                    }

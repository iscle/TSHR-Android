...
public:
    ...
    void Fade(bool in, Sound::DuckVolumeSet *initialVolumes = NULL,
              Sound::DuckVolumeSet *targetVolumes = NULL);

    float GetCurrentVolume(
            Sound::DuckVolumes volumeKnob) { return (m_currentVolumes.duckVolume[volumeKnob]); }

    float GetTargetSettings(
            Sound::DuckVolumes volumeKnob) { return (m_globalDuckSettings.duckVolume[volumeKnob]); }

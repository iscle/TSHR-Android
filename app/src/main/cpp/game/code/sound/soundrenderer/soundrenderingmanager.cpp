...
//=============================================================================
    void daSoundRenderingManager::QueueRadscriptFileLoads() {
        ...
        //
        GetLoadingManager()->AddRequest(FILEHANDLER_SOUND, s_DaSoundTypeInfo.m_Filename,
...
//=============================================================================
    void
    daSoundRenderingManager::LoadTypeInfoFile(const char *filename, SoundFileHandler *fileHandler) {
...
//=============================================================================
    void
    daSoundRenderingManager::LoadScriptFile(const char *filename, SoundFileHandler *fileHandler) {
    ...
    void daSoundRenderingManager::ProcessScript(void *pUserData) {
        ...
        if (m_scriptLoadCount < NumSoundScripts - NUM_TUNING_SCRIPTS) {
            ...
            if (m_scriptLoadCount < NumClusterNames) {
                GetSoundManager()->GetSoundLoader()->SetCurrentCluster(
                        s_ScriptClusters[m_scriptLoadCount]);
            } else {
                GetSoundManager()->GetSoundLoader()->SetCurrentCluster(
                        static_cast<SoundClusterName>(SC_CAR_BASE + m_scriptLoadCount -
                                                      NumClusterNames));
            }
        }

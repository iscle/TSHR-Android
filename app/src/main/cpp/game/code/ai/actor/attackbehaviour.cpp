...
bool
AttackBehaviour::WithinFiringRange(const rmt::Vector &actorPos, const rmt::Vector &target) const {
    bool withinRange;
...
bool AttackBehaviour::WithinFiringArc(const rmt::Vector &actorPos, const rmt::Vector &actorFacing,

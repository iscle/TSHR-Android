...
UFOAttackBehaviour::Apply(Actor *actor, unsigned int timeInMS) {
    ...
    if (addedDesignerVariablesToWatcher == false) {
        radDbgWatchAddFloat(&s_DesignerTunableMaxUFOFiringRange, "Max firing range (meters)",
                            "Actor", NULL, NULL, 1, 75);
...
bool UFOAttackBehaviour::FindPositionInAttackRange(const rmt::Vector &actorPos,

...
EvasionBehaviour::EvasionBehaviour(float minEvadeDistHoriz, float maxEvadeDistHoriz,
                                   float minEvadeDistVert, float maxEvadeDistVert, float speedInKPH)
        :
...
bool EvasionBehaviour::FindEvasionDestination(const rmt::Vector &actorPosition, rmt::Vector *dest) {
    ...
    float distHoriz;
    float distVert;
    distHoriz = (m_MaxEvadeDistHoriz - m_MinEvadeDistHoriz) * s_Randomizer.Float() +
                m_MinEvadeDistHoriz;
    ...
    distVert =
            (m_MaxEvadeDistVert - m_MinEvadeDistVert) * s_Randomizer.Float() + m_MinEvadeDistVert;

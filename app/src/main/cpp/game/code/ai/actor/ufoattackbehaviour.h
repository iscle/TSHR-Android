...
protected:
    ...
    bool FindPositionInAttackRange(const rmt::Vector &actorPos, const rmt::Vector &targetPos,
                                   rmt::Vector *out_destination);
    ...
    int ScanForTargets(const rmt::Vector &actorPosition, float maxRangeSqr,
                       SwapArray<DynaPhysDSG *> *pTargetList);

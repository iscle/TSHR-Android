...
//////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        void Init(IGameObjectWrapper *pAnimCollisionEntityDSG, tPose::Joint *pJoint,
                  bool bAttachToJoint);
...
//////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        public:
            void AddVehicleSelectionInfo(const char *filename, const char *vehiclename,
                                         const char *scroobyname, bool bIncrementSlots = true) {
            ...
            void AddDebugVehicleSelectionInfo(const char *filename, const char *vehiclename,
                                              const char *scroobyname) {
...
///////////////////////////////////////////////////////
    ...
    public:
        ...
        static ButtonHandler *NewAction(EventLocator *pEventLocator, EventEnum event,
                                        GameMemoryAllocator alloc = GMA_LEVEL_OTHER);
    ...
    protected:
        bool OnButtonPressed(Character *pCharacter, Sequencer *pSeq) {
            return OnButtonPressed(pCharacter);
        };

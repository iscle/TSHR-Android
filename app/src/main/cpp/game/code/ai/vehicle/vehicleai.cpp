            ...
            while (mNumSegments < MAX_SEGMENTS) {
                ...
                if (last == NULL) {
                    ...
                    if (mLastRoadSegment->GetRoad() != currRoad) {
                        ...
                        RoadManager::FindClosestPointOnRoad(currRoad, myPos, closePos, closeDist,
                                                            ind);
                        rAssert(ind != -1);
                ...
                } else // if last is not NULL, we have to worry about join point
                {
                    ...
                    mSegments[j].mLength = (mSegments[j].mType == 0) ?
                                           ...
                                           (mSegments[j].mStart -
                                            mSegments[j].mEnd).Magnitude(); // *** SQUARE ROOT! ***
                    mSegments[j].SelfVerify();
...
void
VehicleAI::GetPosAheadAlongRoad(float t, float lookAheadDist, int i, rmt::Vector *lookAheadPos) {
    rAssert(0 <= i && i < mNumSegments);
                ...
                if (distSqr < SEGMENT_BEELINE_RADIUS_SQR) {
                    ...
                    if (closestPt.Equals(closestPtToMySeg, 0.001f)) {
                        ...
                        if (closestPtAt0 && closestPtToMySegAt1) {
                            ...
                            mSegments[i].mLength = (mSegments[i].mEnd -
                                                    mSegments[i].mStart).Magnitude();
                            ...
                            mSegments[0].mLength = (mSegments[0].mEnd -
                                                    mSegments[0].mStart).Magnitude();
                            ...
                            mSegments[1].mLength = (mSegments[1].mEnd -
                                                    mSegments[1].mStart).Magnitude();

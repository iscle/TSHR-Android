...
public: // METHODS
    ...
    void
    CheckForObstacles(ObstacleType &objID, float &distFromObjSqr, void *&obj, bool &objOnMyRight);
...
private: // METHODS
    ...
    bool
    AttemptLaneChange(ObstacleType foundSOMETHING, float distFromSOMETHINGSqr, void *SOMETHING);

...
void OctTreeNode::GrowTreeHeuristic(int iAxis,
    ...
    if (RoomToGrow(iRecursionsRemaining, iMinVertexCount)) {
        ...
        mpChildLT->GrowTreeHeuristic(-1, pListLT, irGranularity, iRecursionsRemaining--,
                                     iMinVertexCount);
        mpChildGT->GrowTreeHeuristic(-1, pListGT, irGranularity, iRecursionsRemaining--,
                                     iMinVertexCount);
    } else {
        mpChildLT = NULL;
        mpChildGT = NULL;
...
void OctTreeNode::GrowTreeHeuristicDebug
    ...
    if (RoomToGrow(iRecursionsRemaining, iMinVertexCount)) {
        ...
        mpChildLT->GrowTreeHeuristicDebug(-1, pListLT, irGranularity, iRecursionsRemaining--,
                                          iMinVertexCount, BoxPtsLT);
        mpChildGT->GrowTreeHeuristicDebug(-1, pListGT, irGranularity, iRecursionsRemaining--,
                                          iMinVertexCount, irBoxPts);

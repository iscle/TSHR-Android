...
//=============================================================================
sim::Solving_Answer
InstDynaPhysDSG::PreReactToCollision(sim::SimState *pCollidedObj, sim::Collision &inCollision) {
...
//=============================================================================
sim::Solving_Answer
InstDynaPhysDSG::PostReactToCollision(rmt::Vector &impulse, sim::Collision &inCollision) {
    ...
    if (mpCollisionAttributes != NULL) {
        ...
        float particleThreshold =
                mpCollisionAttributes->GetMass() * INST_DYNA_MASS_IMPULSE_PARTICLE_BIAS;

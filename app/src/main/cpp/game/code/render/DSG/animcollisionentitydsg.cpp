...
void AnimCollisionEntityDSG::LoadSetUp
    ...
    if (mpDrawable && mpAnimController && ipCollObject) {
        ...
        mpSimStateArticulated = sim::SimStateArticulated::CreateSimStateArticulated(
                mpPoseEngine->GetPose(), ipCollObject, (sim::SimulatedObject *) 0);
...
=============================================================================
*/
sim::Solving_Answer AnimCollisionEntityDSG::PreReactToCollision(sim::SimState *pCollidedObj,
...
//=============================================================================
sim::Solving_Answer
AnimCollisionEntityDSG::PostReactToCollision(rmt::Vector &impulse, sim::Collision &inCollision) {
...
tPose::Joint *AnimCollisionEntityDSG::GetPoseJoint(int jointIndex, bool bAttachToJoint) {
    ...
    if (jointIndex >= 0) {
        pJoint = mpPoseEngine->GetP3DPose()->GetJoint(
                jointIndex);//   GetPose()->GetJoint(jointIndex);
    }

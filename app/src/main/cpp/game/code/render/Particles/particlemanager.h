...
public:
    ...
    void InitializeSystem(ParticleEnum::ParticleID type, tParticleSystemFactory *factory,
                          tEffectController *controller, int maxInstances, bool isDynamic = false);
    ...
    void
    PlayCyclic(ParticlePlayerID id, const ParticleAttributes &attr, const rmt::Matrix &localMatrix);

    void
    PlayCyclic(ParticlePlayerID id, const ParticleAttributes &attr, const rmt::Vector &position);

...
//
//===========================================================================
void VehicleParticleEmitter::PartEmitter::Generate(const ParticleAttributes &attr,
                                                   const rmt::Matrix &vehicleMatrix) {
    Map<ParticleEnum::ParticleID, ParticlePlayerID>::iterator it = mParticlePlayers.find(
            attr.mType);

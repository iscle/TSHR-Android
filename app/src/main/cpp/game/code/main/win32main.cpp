...
//
if(!
Win32Platform::InitializeWindow(hInstance)
)
{
return 0;
}
...
//
Win32Platform *pPlatform = Win32Platform::CreateInstance(hInstance, hPrevInstance, lpCmdLine,
                                                         nCmdShow);
rAssert(pPlatform
!= NULL);
...
//
//=============================================================================
void ProcessCommandLineArguments(LPSTR
lpCmdLine)
{
char *argument;
...
if(!
CommandLineOptions::Get(CLO_ART_STATS)
)
{

...
const unsigned int SuperSprintData::NUM_CHARACTER_NAMES =
        sizeof(SuperSprintData::CHARACTER_NAMES) / sizeof(SuperSprintData::CHARACTER_NAMES[0]);
...
const unsigned int SuperSprintData::NUM_NAMES =
        sizeof(SuperSprintData::VEHICLE_NAMES) / sizeof(SuperSprintData::VEHICLE_NAMES[0]);

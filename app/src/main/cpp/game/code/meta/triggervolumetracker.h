...
private:
    ...
    void TestVolume(TriggerVolume *vol, rmt::Vector &center, float radius, int playerID,
                    unsigned int time);
...
inline TriggerVolumeTracker *
GetTriggerVolumeTracker() { return (TriggerVolumeTracker::GetInstance()); }

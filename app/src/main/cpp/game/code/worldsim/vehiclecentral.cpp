...
static void ConsoleHookSetTireLateralResistanceNormal(int argc, char **argv) {
    ...
    float value = static_cast<float>(atof(argv[1]));
    GetVehicleCentral()->GetCurrentVehicleUnderConstruction()->SetTireLateralResistanceNormal(
            value);
}
...
static void ConsoleHookSetSlipSteeringNoEBrake(int argc, char **argv) {
    ...
    float value = static_cast<float>(atof(argv[1]));
    GetVehicleCentral()->GetCurrentVehicleUnderConstruction()->SetTireLateralResistanceSlipWithoutEBrake(
            value);
}
...
static void ConsoleHookSetCharactersVisible(int argc, char **argv) {
    ...
    GetVehicleCentral()->GetCurrentVehicleUnderConstruction()->mVisibleCharacters = (
            atoi(argv[1]) != 0);
}
...
static void ConsoleHookSetIrisTransition(int argc, char **argv) {
    ...
    GetVehicleCentral()->GetCurrentVehicleUnderConstruction()->mIrisTransition = (atoi(argv[1]) !=
                                                                                  0);
}
...
static void ConsoleHookSetCharacterScale(int argc, char **argv) {
    ...
    GetVehicleCentral()->GetCurrentVehicleUnderConstruction()->mCharacterScale = static_cast<float>(atof(
            argv[1]));
}
...
void VehicleCentral::SetupConsoleFunctionsForVehicleTuning() {
    ...
    GetConsole()->AddFunction("SetGasScale", ConsoleHookSetGasScale, "help your goddamn self", 1,
                              1);

    GetConsole()->AddFunction("SetHighSpeedGasScale", ConsoleHookSetHighSpeedGasScale,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetGasScaleSpeedThreshold", ConsoleHookSetGasScaleSpeedThreshold,
                              "help your goddamn self", 1, 1);


    GetConsole()->AddFunction("SetSlipGasScale", ConsoleHookSetSlipGasScale,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetBrakeScale", ConsoleHookSetBrakeScale, "help your goddamn self",
                              1, 1);
    GetConsole()->AddFunction("SetTopSpeedKmh", ConsoleHookSetTopSpeedKmh, "help your goddamn self",
                              1, 1);
    GetConsole()->AddFunction("SetMaxWheelTurnAngle", ConsoleHookSetMaxWheelTurnAngle,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetHighSpeedSteeringDrop", ConsoleHookSetHighSpeedSteeringDrop,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetTireGrip", ConsoleHookSetTireLateralStaticGrip,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetNormalSteering", ConsoleHookSetTireLateralResistanceNormal,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetSlipSteering", ConsoleHookSetTireLateralResistanceSlip,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetEBrakeEffect", ConsoleHookSetEBrakeEffect,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetCMOffsetX", ConsoleHookSetCMOffsetX, "help your goddamn self", 1,
                              1);
    GetConsole()->AddFunction("SetCMOffsetY", ConsoleHookSetCMOffsetY, "help your goddamn self", 1,
                              1);
    GetConsole()->AddFunction("SetCMOffsetZ", ConsoleHookSetCMOffsetZ, "help your goddamn self", 1,
                              1);

    GetConsole()->AddFunction("SetSuspensionLimit", ConsoleHookSetSuspensionLimit,
                              "help your goddamn self", 1, 1);
    ...
    GetConsole()->AddFunction("SetSuspensionYOffset", ConsoleHookSetSuspensionYOffset,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetHitPoints", ConsoleHookSetHitPoints, "help your goddamn self", 1,
                              1);

    GetConsole()->AddFunction("SetBurnoutRange", ConsoleHookSetBurnoutRange,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetMaxSpeedBurstTime", ConsoleHookSetMaxSpeedBurstTime,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetDonutTorque", ConsoleHookSetDonutTorque, "help your goddamn self",
                              1, 1);

    GetConsole()->AddFunction("SetSlipSteeringNoEBrake", ConsoleHookSetSlipSteeringNoEBrake,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetSlipEffectNoEBrake", ConsoleHookSetSlipEffectNoEBrake,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetWeebleOffset", ConsoleHookSetWeebleOffset,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetWheelieRange", ConsoleHookSetWheelieRange,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetWheelieOffsetY", ConsoleHookSetWheelieOffsetY,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetWheelieOffsetZ", ConsoleHookSetWheelieOffsetZ,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SetShadowAdjustments", ConsoleHookSetShadowAdjustments,
                              "Move the shadow points around", 8, 8);
    GetConsole()->AddFunction("SetShininess", ConsoleHookSetShininess,
                              "Set the environmental reflection 0 to 1", 1, 1);

    GetConsole()->AddFunction("SetDriver", ConsoleHookSetDriverName, "help your goddamn self", 1,
                              1);
    GetConsole()->AddFunction("SetGamblingOdds", ConsoleHookSetGamblingOdds, "Set Gambling Odds", 1,
                              1);

    GetConsole()->AddFunction("SetHasDoors", ConsoleHookSetHasDoors, "help your goddamn self", 1,
                              1);
    GetConsole()->AddFunction("SetCharactersVisible", ConsoleHookSetCharactersVisible,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetIrisTransition", ConsoleHookSetIrisTransition,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetAllowSeatSlide", ConsoleHookSetAllowSlide,
                              "help your goddamn self", 1, 1);
    GetConsole()->AddFunction("SetHighRoof", ConsoleHookSetHighRoof, "help your goddamn self", 1,
                              1);
    GetConsole()->AddFunction("SetCharacterScale", ConsoleHookSetCharacterScale,
                              "help your goddamn self", 1, 1);

    GetConsole()->AddFunction("SuppressDriver", ConsoleHookSuppressDriver, "help your goddamn self",
                              1, 1);
}
...
void VehicleCentral::PreLoad() {
    ...
    tRefCounted::Assign(mHeadLights[0],
                        p3d::find<tBillboardQuadGroup>(tEntity::MakeUID("headlightShape8")));
    tRefCounted::Assign(mHeadLights[1],
                        p3d::find<tBillboardQuadGroup>(tEntity::MakeUID("headlight2Shape")));
    tRefCounted::Assign(mHeadLights[2],
                        p3d::find<tBillboardQuadGroup>(tEntity::MakeUID("glowGroupShape2")));
...
//
//=============================================================================
Vehicle *VehicleCentral::InitVehicle(const char *name, bool addToActiveVehicleList, char *confile,
                                     VehicleType vt, DriverInit driver, bool playercar,
                                     bool startoutofcar) {
...
//#endif
    ...
    bool ok = vehicle->Init(name, GetWorldPhysicsManager()->mSimEnvironment, VL_PHYSICS, vt,
                            startoutofcar);
    rAssert(ok);
    ...
    mCurrentVehicleUnderConstructionTail =
            (mCurrentVehicleUnderConstructionTail + 1) % MAX_ACTIVE_VEHICLES;
...
int VehicleCentral::AddVehicleToActiveList(Vehicle *vehicle) {
    ...
    ActionButton::GetInCar *pABHandler = static_cast<ActionButton::GetInCar *>(GetActionButtonManager()->GetActionByIndex(
            id));
            ...
            if (vController != 0) {
                ...
                */
                ...
                if (GetCheatInputSystem()->IsCheatEnabled(CHEAT_ID_CAR_JUMP_ON_HORN) &&
                    vehicle == GetAvatarManager()->GetAvatarForPlayer(
                            0)->GetVehicle())    //   vehicle->mVehicleType == VT_USER)
                {
                ...
                if (vController->GetHorn() > 0.0f) {
                    ...
                    if (vehicle == GetAvatarManager()->GetAvatarForPlayer(0)->GetVehicle() ||
                        ...
                        if (::GetGameplayManager()->GetGameType() ==
                            GameplayManager::GT_SUPERSPRINT) {
...
void VehicleCentral::Update(float dt) {
    ...
    for (i = 0; i < MAX_ACTIVE_VEHICLES; i++) {
        ...
        if (mActiveVehicleList[i] &&
            (GetRenderManager()->rCurWorldRenderLayer() ==
             mActiveVehicleList[i]->GetRenderLayerEnum())) {
            ...
            if (mActiveVehicleList[i] != NULL) {
                if (mActiveVehicleList[i]->GetLocomotionType() == VL_PHYSICS) {
                    ...
                    GetWorldPhysicsManager()->UpdateDynamicObjects(dt,
                                                                   mActiveVehicleList[i]->mCollisionAreaIndex);
                    GetWorldPhysicsManager()->UpdateAnimCollisions(dt,
                                                                   mActiveVehicleList[i]->mCollisionAreaIndex);
    ...
    for (i = 0; i < MAX_ACTIVE_VEHICLES; i++) {
        if (mActiveVehicleList[i] &&
                ...
                //if(mActiveVehicleList[i]->GetLocomotionType() == VL_PHYSICS)
            {
                ...
                float radius = mActiveVehicleList[i]->GetWheelBase() *
                               2.0f;    // TODO - what magic number?
                ...
                if (playerVehicle && mActiveVehicleList[i] == playerVehicle) {
                    GetWorldPhysicsManager()->SubmitStaticsPseudoCallback(position, radius,
                                                                          collisionAreaIndex,
                                                                          mActiveVehicleList[i]->GetSimState(),
                                                                          true);
                    GetWorldPhysicsManager()->SubmitFencePiecesPseudoCallback(position, radius,
                                                                              collisionAreaIndex,
                                                                              mActiveVehicleList[i]->GetSimState(),
                                                                              true);
                } else {
    ...
    for (i = 0; i < MAX_ACTIVE_VEHICLES; i++) {
        if (mActiveVehicleList[i] &&
            ...
            if (mActiveVehicleList[i]->mVehicleType == VT_USER) {
                ...
                if (playerVehicle && mActiveVehicleList[i] == playerVehicle) {
                    GetWorldPhysicsManager()->SubmitDynamicsPseudoCallback(position, radius,
                                                                           collisionAreaIndex,
                                                                           mActiveVehicleList[i]->GetSimState(),
                                                                           true);
                } else {
    ...
    for (i = 0; i < MAX_ACTIVE_VEHICLES; i++) {
        if (mActiveVehicleList[i] &&
                ...
                //if(mActiveVehicleList[i]->GetLocomotionType() == VL_PHYSICS)
            {
                ...
                float collradius = mActiveVehicleList[i]->GetWheelBase() *
                                   2.0f;    // TODO - what magic number?

                int collisionAreaIndex = mActiveVehicleList[i]->mCollisionAreaIndex;
                rAssert(collisionAreaIndex != -1);

                GetWorldPhysicsManager()->SubmitAnimCollisionsPseudoCallback(position, collradius,
                                                                             collisionAreaIndex,
                                                                             mActiveVehicleList[i]->GetSimState());

                float updateradius = collradius * 1.0f;    //? TODO - what magic number
                GetWorldPhysicsManager()->SubmitAnimCollisionsForUpdateOnly(position, updateradius,
                                                                            collisionAreaIndex);
            }
        }
    }
...
void VehicleCentral::OnProcessRequestsComplete(void *pUserData) {
    ...
    mCurrentVehicleUnderContructionHead =
            (mCurrentVehicleUnderContructionHead + 1) % MAX_ACTIVE_VEHICLES;
...
void VehicleCentral::SetupDriver(Vehicle *vehicle) {
    if (vehicle->GetDriver()) {
        if ((vehicle->GetDriver() != GetCharacterManager()->GetCharacter(0)) &&
            (vehicle->GetDriver()->GetRole() != Character::ROLE_PEDESTRIAN)) {
        ...
        if ((vehicle->GetDriverName()[0] != 0)) {
            if (strcmp(vehicle->GetDriverName(), "phantom") == 0) {
                ...
                if ((strcmp(vehicle->GetDriverName(), "none") != 0) &&
                    ((vehicle->mDriverInit == FORCE_DRIVER) ||
                     !IsDriverSuppressed(vehicle->GetDriverName()))) {
                    char uniqueName[16];
                    ...
                    if (character && ((character->GetTargetVehicle() == vehicle) ||
                                      (character->GetTargetVehicle() == NULL))) {
                        GetCharacterManager()->RemoveCharacter(character);
                    }

                    character = GetCharacterManager()->AddCharacter(CharacterManager::NPC,
                                                                    uniqueName,
                                                                    vehicle->GetDriverName(), "npd",
                                                                    "");

                    static_cast<NPCController *>(character->GetController())->TransitToState(
                            NPCController::NONE);

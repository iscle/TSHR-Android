...
void SkidMarkGenerator::InitShaders() {
    ...
    rTuneWarningMsg(spPavementShader != NULL,
                    "Pavement skid shader not found in inventory! Some skids will not appear!");
    ...
    rTuneWarningMsg(spDirtShader != NULL,
                    "Dirt skid shader not found in inventory! Some skids will not appear!");
    ...
    rTuneWarningMsg(spGrassShader != NULL,
                    "Grass skid shader not found in inventory! Some skids will not appear!");
...
void SkidMarkGenerator::GenerateSkid(int wheel, const SkidMarkGenerator::SkidData &skidData) {
    ...
    if (generatorData.currentSkid != NULL) {
        ...
        bool angleTooSharp = generatorData.currentSkid->GetCurrentDirection().Dot(skidDirection) <
                             ANGLE_TOO_SHARP;
    ...
    if (generatorData.currentSkid != NULL) {
        ...
        if (generatorData.currentSkid->SpaceLeft()) {
            generatorData.currentSkid->Extend(skidCenter, skidDirection, skidData.groundPlaneNormal,
                                              generatorData.halfWidth, dampenedIntensity);
            ...
            if (skidMark != NULL) {
                ...
                generatorData.currentSkid->Extend(skidCenter, skidDirection,
                                                  skidData.groundPlaneNormal,
                                                  generatorData.halfWidth, dampenedIntensity);
                generatorData.skidExtendedThisFrame = true;
            } else {
                // No space available!

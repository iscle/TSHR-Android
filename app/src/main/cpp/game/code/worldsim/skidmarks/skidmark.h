...
public:
    ...
    virtual void
    GetBoundingSphere(rmt::Sphere *sphere) { *sphere = m_BoundingBox.GetBoundingSphere(); }
    ...
    void
    Extend(const rmt::Vector &position, const rmt::Vector &forward, const rmt::Vector groundNormal,
           float halfWidth, float intensity);
...
private:
    ...
    bool
    FindTextureBreakPosition(const rmt::Vector &position, rmt::Vector *texBreakPosition, float *u,
                             float *distanceToTBP, float *distanceToGivenPoint);

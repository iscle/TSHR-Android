...
public:
    ...
    static Sparkle *CreateInstance(unsigned char NumTextures = ST_NUM_TEXTURES,
                                   unsigned short NumSparkles = DEFAULT_NUM_SPARKLES);
    ...
    void
    AddSparkle(const rmt::Vector &Position, float Size, float Duration, const rmt::Vector &Velocity,
               eSparkleEffect Effect);

    void AddGagSparkle(const rmt::Vector &Position, float Size, float Strength,
                       unsigned int Caller); // See notes for information on the Caller.
    void AddSparks(const rmt::Vector &Position, const rmt::Vector &Velocity, float Strength);

    void AddDash(const rmt::Vector &Position, const rmt::Vector &Velocity,
                 float Strength); // NOTE: Velocity is direction of character travel.
    ...
    void AddPaintChips(const rmt::Vector &Position, const rmt::Vector &Velocity, pddiColour colour,
                       float Strength);
    ...
    void
    AddSmoke(const rmt::Matrix &Transform, const rmt::Vector &Offset, const rmt::Vector &Velocity,
             float Strength);

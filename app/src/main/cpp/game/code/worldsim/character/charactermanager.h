...
public:
    ...
    //
    Character *AddCharacter(CharacterType, const char *characterName, const char *modelName,
                            const char *choreoPuppet, const char *location = NULL);

    Character *
    AddCharacterDeferedLoad(CharacterType, const char *characterName, const char *modelName,
                            const char *choreoPuppet, const char *location = NULL);

    // preload data for a character
    //
    void PreloadCharacter(const char *name, const char *anim,
                          LoadingManager::ProcessRequestsCallback *callback = NULL,
                          void *userData = NULL) {
        LoadAnimation(anim);
        LoadModel(name, callback, userData);
    }
    ...
    //
    Character *AddPCCharacter(const char *characterName, const char *choreoPuppet) {
        return AddCharacter(PC, characterName, characterName, choreoPuppet);
    }
...
private:
    ...
    unsigned LoadModel(const char *model, LoadingManager::ProcessRequestsCallback *callback = NULL,
                       void *userData = NULL);

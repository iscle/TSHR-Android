...
//
//=============================================================================
Solving_Answer WorldCollisionSolverAgentManager::CollisionEvent(SimState *inSimStateA, int indexA,
...
*/
Solving_Answer
WorldCollisionSolverAgentManager::PreCollisionEvent(Collision &inCollision, int inPass) {
    ...
    for (i = 0; i < NUM_SOLVERS; i++) {
        ...
        if (Solving_Aborted ==
            mpCollisionSolverAgentArray[i]->PreCollisionEvent(inCollision, inPass)) {
            return Solving_Aborted;
        }
    }
...
*/
Solving_Answer
WorldCollisionSolverAgentManager::TestImpulse(rmt::Vector &impulse, Collision &inCollision) {
    int i;
...
Solving_Answer
WorldCollisionSolverAgentManager::EndObjectCollision(SimState *inSimState, int inIndex) {

    int i;
    for (i = 0; i < NUM_SOLVERS; i++) {
        rAssert(mpCollisionSolverAgentArray[i] != (CollisionSolverAgent *) 0);
        if (Solving_Aborted ==
            mpCollisionSolverAgentArray[i]->EndObjectCollision(inSimState, inIndex)) {
            return Solving_Aborted;
        }
    }
    return Solving_Continue;

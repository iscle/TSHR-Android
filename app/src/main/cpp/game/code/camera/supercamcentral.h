...
public:
    ...
    enum SelectFlag {
        CUT = 0x00000001, QUICK = 0x00000010, FORCE = 0x00000100, NO_TRANS = 0x10000000
    };
...
private:
    void
    SetActiveSuperCam(unsigned int which = 0, int flags = CUT | QUICK, unsigned int timems = 7000);

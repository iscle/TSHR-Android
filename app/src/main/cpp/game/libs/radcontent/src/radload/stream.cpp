...
void radLoadCreateStream(radLoadStream **stream, radLoadOptions *options,
...
void
radLoadCreateDataStream(radLoadStream **stream, unsigned char *buffer, unsigned int size, bool del,
                        radLoadUpdatableRequest *request) {
...
// radLoadDataStream ---------------------------------------------------------
radLoadDataStream::radLoadDataStream(unsigned char *buffer, unsigned int size, bool del,
                                     radLoadUpdatableRequest *request)
        :

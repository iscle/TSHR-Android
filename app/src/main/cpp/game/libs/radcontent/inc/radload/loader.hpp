...
void radLoadCreateLoaderStream(radLoadStream **stream, radLoadOptions *options,
                               radLoadUpdatableRequest *request = NULL);

/// Create an radLoadStream object from a file on disk
void radLoadCreateFileStream(radLoadStream **stream, const char *filename,
                             radLoadUpdatableRequest *request = NULL);

/// Create an radLoadStream object from a chunk of memory
void radLoadCreateDataStream(radLoadStream **stream, const unsigned char *buffer, unsigned int size,
                             radLoadUpdatableRequest *reqeust = NULL);

...
//---------------------------------------------------------
tBillboardQuadGroupAnimationController::tBillboardQuadGroupAnimationController(
        tBillboardQuadGroupAnimationController *c) :
...
void tBillboardQuadGroupAnimationController::Update() {
    ...
    for (int i = 0; i < animation->GetNumGroups(); i++) {
        ...
        if (animationGroup) {
            ...
            if (quad) {
                visibility = animationGroup->GetBoolChannel(
                        Pure3DAnimationChannels::BillboardObjects::VISIBILITY_VIS);
                translation = animationGroup->GetVectorChannel(
                        Pure3DAnimationChannels::BillboardObjects::TRANSLATION_TRAN);
                width = animationGroup->GetFloat1Channel(
                        Pure3DAnimationChannels::BillboardObjects::WIDTH_WDT);
                height = animationGroup->GetFloat1Channel(
                        Pure3DAnimationChannels::BillboardObjects::HEIGHT_HGT);
                distance = animationGroup->GetFloat1Channel(
                        Pure3DAnimationChannels::BillboardObjects::DISTANCE_DIST);
                colour = animationGroup->GetColourChannel(
                        Pure3DAnimationChannels::BillboardObjects::COLOUR_CLR);
                uvOffset = animationGroup->GetFloat2Channel(
                        Pure3DAnimationChannels::BillboardObjects::UVOFFSET_OFF);
                uvOffsetRange = animationGroup->GetFloat2Channel(
                        Pure3DAnimationChannels::BillboardObjects::UVOFFSET_RANGE_ORNG);
                sourceRange = animationGroup->GetFloat1Channel(
                        Pure3DAnimationChannels::BillboardObjects::SOURCE_RANGE_SRNG);
                edgeRange = animationGroup->GetFloat1Channel(
                        Pure3DAnimationChannels::BillboardObjects::EDGE_RANGE_ERNG);

...
//-------------------------------------------------------------------
template<class T>
void FilterImage(unsigned *src, unsigned *dest, int width, int height) {
    int w = width / 2;
    int h = height / 2;

    for (int y = 0; y < h; y++) {
        for (int x = 0; x < w; x++) {
            *dest++ = T::Filter(*(pddiColour *) src, *(pddiColour * )(src + 1),
                                *(pddiColour * )(src + width), *(pddiColour * )(src + width + 1));
            src += 2;
        }
        src += width;
    }
...
//-------------------------------------------------------------------
template<class T>
void FilterImageAC(unsigned *src, unsigned *dest, int width, int height) {
    int w = width / 2;
    int h = height / 2;

...
protected:
    tTexture *LoadImage(tChunkFile *, tImageFactory *factory = NULL, tTexture *texture = NULL,
                        int mipLevel = 0);

    tTexture *LoadVolumeImage(tChunkFile *, tImageFactory *factory = NULL, tTexture *texture = NULL,
                              int mipLevel = 0, int numMipMaps = 0);

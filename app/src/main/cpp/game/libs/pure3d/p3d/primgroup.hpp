...
public:
    ...
    tPrimGroupOptimised(tPrimGroupStreamed &pgStreamed, unsigned optimisationHint = 0,
                        bool writeOnce = true);
...
public:
    ...
    virtual tPrimGroup *
    Load(tChunkFile *file, tEntityStore *store, rmt::Matrix *bones, bool optimise, bool deform);

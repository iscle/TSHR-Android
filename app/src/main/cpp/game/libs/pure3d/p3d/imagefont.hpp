...
public:
    ...
    virtual void
    DisplayText(tImage *image, int x, int y, const P3D_UNICODE *text, int formatting = 0) const;
...
protected:
    ...
    virtual void
    DisplayLine(tImage *image, int x, int y, const P3D_UNICODE *text, int formatting = 0) const;

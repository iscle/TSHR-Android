    ...
    while (f->ChunksRemaining()) {
        ...
        switch (id) {
            case Pure3D::Animation::VertexAnim::OffsetList::COLOUR: {
                tColourOffsetList *cl = (tColourOffsetList *) loader.LoadObject(f, store, id,
                                                                                param);
                P3DASSERT(cl);
                cl->AddRef();
                key->mColour = cl;
            ...
            case Pure3D::Animation::VertexAnim::OffsetList::VECTOR: {
                tVectorOffsetList *vl = (tVectorOffsetList *) loader.LoadObject(f, store, id,
                                                                                param);
                P3DASSERT(vl);
                vl->AddRef();
            ...
            case Pure3D::Animation::VertexAnim::OffsetList::VECTOR2: {
                tVector2OffsetList *vl = (tVector2OffsetList *) loader.LoadObject(f, store, id,
                                                                                  param);
                P3DASSERT(vl);
                vl->AddRef();
...
//-----------------------------tOffsetListLoader--------------------------------
tOffsetIndexList *
tOffsetListLoader::LoadObject(tChunkFile *f, tEntityStore *store, unsigned id, int &param) {
...
tOffsetIndexList *
tOffsetListLoader::LoadVectorOffsetList(tChunkFile *f, tEntityStore *store, int &param) {
    unsigned version = f->GetUInt();
    P3DASSERT(version == VERTEXANIM_VERSION);
...
tOffsetIndexList *
tOffsetListLoader::LoadVector2OffsetList(tChunkFile *f, tEntityStore *store, int &param) {
    unsigned version = f->GetUInt();
    P3DASSERT(version == VERTEXANIM_VERSION);

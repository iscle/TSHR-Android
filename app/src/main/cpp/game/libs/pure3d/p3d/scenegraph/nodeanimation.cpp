...
//-------------------------------------------------------------------
    void TransformAnimationController::UpdateNoBlending() {
        ...
        const tVectorChannel *translation = animGroup->GetVectorChannel(
                Pure3DAnimationChannels::SceneGraph::TRANSLATION_TRAN);
        const tRotationChannel *rotation = animGroup->GetRotationChannel(
                Pure3DAnimationChannels::SceneGraph::ROTATION_ROT);

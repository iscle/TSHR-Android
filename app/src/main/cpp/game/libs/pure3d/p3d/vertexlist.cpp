...
//-------------------------------------------------------------------
template<class T>
static inline void StreamInternal(tVertexList *list, T *stream, int start, int count) {
    int i;
...
///
template<class T>
static inline void StreamWithOffsetInternal(tVertexList *list, T *stream, int start, int count) {
    int i;
    pddiVector *p = (pddiVector *) list->GetPositions();
    pddiColour *c[tVertexList::MAX_NUM_COLOUR_SETS];
    for (i = 0; i < tVertexList::MAX_NUM_COLOUR_SETS; i++) {

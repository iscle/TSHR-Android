...
#if !defined(RAD_GAMECUBE) && !defined(RAD_PS2) && !defined(RAD_XBOX) && !defined(RAD_WIN32) && !defined(RAD_LINUX) && !defined(RAD_ANDROID)
#error No platform defined (define one of RAD_GAMECUBE, RAD_PS2, RAD_XBOX, RAD_WIN32, RAD_LINUX or RAD_ANDROID)
#endif

...
public:
    ...
    tSprite(tImage *, tShader *Shader = NULL, int blitBorder = 1, int nativeX = 640,
            int nativeY = 480, tImageConverter *conv = 0);

    tSprite(tTexture **, int w, int h, int count, tShader *Shader = NULL, int blitBorder = 1,
            int nativeX = 640, int nativeY = 480, tImageConverter *conv = 0);
...
protected:
    ...
    void BuildTexture(int texNum, tRect &src, int newX, int newY, tImage *image, tImage *buffer,

    ...
    if (useMultiCBV) {
        ...
        switch (multiCBVBlendMode) {
            ...
            case PDDI_MULTI_CBV_BLEND_SUBTRACT:  // SetA - f * SetB
            {
                ...
                d3d->SetTextureCombine(0, D3DTOP_MODULATE, multiCBVBlendSetB,
            ...
            case PDDI_MULTI_CBV_BLEND_MODULATE:  // SetA * ((1-f) * 1 + f * SetB
            {
                ...
                d3d->SetTextureCombine(1, D3DTOP_BLENDFACTORALPHA, D3DTA_CURRENT,
                                       multiCBVBlendSetA);
                SetupTextureSampling(1);
            ...
            default: {
                ...
                d3d->SetTextureCombine(0, D3DTOP_BLENDFACTORALPHA, multiCBVBlendSetB,
                                       multiCBVBlendSetA);
                SetupTextureSampling(0);
        ...
        {
            d3d->SetTextureColourCombine(modulateTextureStage, D3DTOP_MODULATE, D3DTA_TEXTURE,
                                         D3DTA_CURRENT);
            if ((multiCBVBlendSetA == D3DTA_TFACTOR) || (multiCBVBlendSetB == D3DTA_TFACTOR)) {
                // Blend alpha is invalid so just use texture alpha.
                d3d->SetTextureAlphaCombine1(modulateTextureStage, D3DTOP_SELECTARG1,
                                             D3DTA_TEXTURE);
            } else {
                d3d->SetTextureAlphaCombine(modulateTextureStage, D3DTOP_MODULATE, D3DTA_TEXTURE,
                                            D3DTA_CURRENT);
            }

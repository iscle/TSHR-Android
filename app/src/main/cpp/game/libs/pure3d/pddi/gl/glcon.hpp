...
public :
    ...
    pddiPrimStream *BeginPrims(pddiShader *material, pddiPrimType primType, unsigned vertexType,
...
public:
    pglPrimBuffer(pglContext *context, pddiPrimType type, unsigned vertexFormat, int nVertex,
                  int nIndex);

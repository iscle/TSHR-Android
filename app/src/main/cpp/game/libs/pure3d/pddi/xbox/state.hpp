...
public:
    ...
    void
    SetTextures(unsigned nStages, pddiTexture *tex0, pddiTexture *tex1 = 0, pddiTexture *tex2 = 0,
                pddiTexture *tex3 = 0) {
        SetTexture(0, tex0);
        SetTexture(1, tex1);
        SetTexture(2, tex2);
    ...
    void SetAlphaBlend(pddiBlendMode mode) {
        SetAlphaBlend(alphaBlendTable[mode].enable, alphaBlendTable[mode].op,
                      alphaBlendTable[mode].src, alphaBlendTable[mode].dest);
    }

...
public:
    ...
    pddiFloatRect(float l, float t, float r, float b) {
        left = l;
        top = t;
        right = r;
        bottom = b;
...
public:
    ...
    void Set(float n, float f, float fv, float ar) {
        nearPlane = n;
        farPlane = f;
        fov = fv;
        aspect = ar;
...
public:
    ...
    BeginPrims(pddiShader *material, pddiPrimType primType, unsigned vertexType,
               int vertexCount = 0, unsigned pass = 0);

...
public:
    ...
    bool Create(int xSize, int ySize, int bitdepth, int alphaDepth, int nMipMap,
...
protected:
    ...
    int VramAlloc(unsigned w, unsigned h, unsigned bpp, unsigned mipmaps, unsigned short *tbp,
                  unsigned short *cbp, bool alignToPage = true);

...
void d3dRefractVertexShader::LoadVSConstants() {
    ...
    float scaledBiasX = bias * (((float) context->GetDisplay()->GetRenderTargetWidth()) /
                                ((float) context->GetDisplay()->GetWidth()));
    float scaledBiasY = bias * (((float) context->GetDisplay()->GetRenderTargetHeight()) /
                                ((float) context->GetDisplay()->GetHeight()));

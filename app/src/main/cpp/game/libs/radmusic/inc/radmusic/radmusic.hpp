...
//----------------------------------------------------------------------------
    ...
    unsigned int
    stream_graph_queue_data_source(stream_graph *, IRadSoundHalDataSource *, unsigned int length);
...
//----------------------------------------------------------------------------
    ...
    void sequence_player_queue(sequence_player *, unsigned int resource_buffer, stream_graph *,
                               bool resetState);
...
//----------------------------------------------------------------------------
    ...
    void
    performance_state_value_name(performance *p, unsigned int, unsigned int, char *, unsigned int);

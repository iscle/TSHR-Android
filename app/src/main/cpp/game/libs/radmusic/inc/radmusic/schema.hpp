...
//
    struct _comp;
    typedef pointer_templ <_comp> comp;
    struct _group;
    typedef pointer_templ <_group> group;
    struct _fade_transition;
    typedef pointer_templ <_fade_transition> fade_transition;
    struct _stitch_transition;
    typedef pointer_templ <_stitch_transition> stitch_transition;
    struct _event;
    typedef pointer_templ <_event> event;
    struct _event_matrix;
    typedef pointer_templ <_event_matrix> event_matrix;
    struct _state;
    typedef pointer_templ <_state> state;
    struct _rsd_file;
    typedef pointer_templ <_rsd_file> rsd_file;
    struct _stream;
    typedef pointer_templ <_stream> stream;
    struct _clip;
    typedef pointer_templ <_clip> clip;
    struct _region;
    typedef pointer_templ <_region> region;
    struct _sequence;
    typedef pointer_templ <_sequence> sequence;
    struct _layer;
    typedef pointer_templ <_layer> layer;
    struct _event_clip;
    typedef pointer_templ <_event_clip> event_clip;
    struct _event_stream;
    typedef pointer_templ <_event_stream> event_stream;
    struct _event_silence;
    typedef pointer_templ <_event_silence> event_silence;
    struct _event_var_volume;
    typedef pointer_templ <_event_var_volume> event_var_volume;
    struct _event_var_pitch;
    typedef pointer_templ <_event_var_pitch> event_var_pitch;
    struct _event_var_volume_rand_min;
    typedef pointer_templ <_event_var_volume_rand_min> event_var_volume_rand_min;
    struct _event_var_volume_rand_max;
    typedef pointer_templ <_event_var_volume_rand_max> event_var_volume_rand_max;
    struct _event_var_pitch_rand_min;
    typedef pointer_templ <_event_var_pitch_rand_min> event_var_pitch_rand_min;
    struct _event_var_pitch_rand_max;
    typedef pointer_templ <_event_var_pitch_rand_max> event_var_pitch_rand_max;
    struct _event_var_aux_gain;
    typedef pointer_templ <_event_var_aux_gain> event_var_aux_gain;
    struct _event_var_positional;
    typedef pointer_templ <_event_var_positional> event_var_positional;
    struct _event_var_pos_fall_off;
    typedef pointer_templ <_event_var_pos_fall_off> event_var_pos_fall_off;
    struct _event_var_pos_dist_min;
    typedef pointer_templ <_event_var_pos_dist_min> event_var_pos_dist_min;
    struct _event_var_pos_dist_max;
    typedef pointer_templ <_event_var_pos_dist_max> event_var_pos_dist_max;
    struct _event_callback;
    typedef pointer_templ <_event_callback> event_callback;
    struct _event_logic_and;
    typedef pointer_templ <_event_logic_and> event_logic_and;
    struct _event_logic_or;
    typedef pointer_templ <_event_logic_or> event_logic_or;
    struct _event_logic_repeat;
    typedef pointer_templ <_event_logic_repeat> event_logic_repeat;
    struct _play_region_action;
    typedef pointer_templ <_play_region_action> play_region_action;
    struct _push_region_action;
    typedef pointer_templ <_push_region_action> push_region_action;
    struct _pop_region_action;
    typedef pointer_templ <_pop_region_action> pop_region_action;
    struct _start_layer_action;
    typedef pointer_templ <_start_layer_action> start_layer_action;
    struct _stop_layer_action;
    typedef pointer_templ <_stop_layer_action> stop_layer_action;
    struct _rand_state_action;
    typedef pointer_templ <_rand_state_action> rand_state_action;
    struct _audio_format;
    typedef pointer_templ <_audio_format> audio_format;
    struct _tempo_track;
    typedef pointer_templ <_tempo_track> tempo_track;
    struct _sequence_event;
    typedef pointer_templ <_sequence_event> sequence_event;
    struct _beat_set;
    typedef pointer_templ <_beat_set> beat_set;
    struct _action;
    typedef pointer_templ <_action> action;

//
// ref types
//
    struct _group_ref;
    typedef pointer_templ <_group_ref> group_ref;
    struct _rsd_file_ref;
    typedef pointer_templ <_rsd_file_ref> rsd_file_ref;
    struct _sequence_event_ref;
    typedef pointer_templ <_sequence_event_ref> sequence_event_ref;
    struct _stream_ref;
    typedef pointer_templ <_stream_ref> stream_ref;
    struct _clip_ref;
    typedef pointer_templ <_clip_ref> clip_ref;
    struct _region_ref;
    typedef pointer_templ <_region_ref> region_ref;
    struct _state_ref;
    typedef pointer_templ <_state_ref> state_ref;
    struct _action_ref;
    typedef pointer_templ <_action_ref> action_ref;
    struct _event_matrix_ref;
    typedef pointer_templ <_event_matrix_ref> event_matrix_ref;
    struct _layer_ref;
    typedef pointer_templ <_layer_ref> layer_ref;
    struct _sequence_ref;
    typedef pointer_templ <_sequence_ref> sequence_ref;

//
// array types
//
    struct _group_array;
    typedef pointer_templ <_group_array> group_array;
    struct _fade_transition_array;
    typedef pointer_templ <_fade_transition_array> fade_transition_array;
    struct _stitch_transition_array;
    typedef pointer_templ <_stitch_transition_array> stitch_transition_array;
    struct _event_array;
    typedef pointer_templ <_event_array> event_array;
    struct _event_matrix_array;
    typedef pointer_templ <_event_matrix_array> event_matrix_array;
    struct _state_array;
    typedef pointer_templ <_state_array> state_array;
    struct _rsd_file_array;
    typedef pointer_templ <_rsd_file_array> rsd_file_array;
    struct _stream_array;
    typedef pointer_templ <_stream_array> stream_array;
    struct _clip_array;
    typedef pointer_templ <_clip_array> clip_array;
    struct _region_array;
    typedef pointer_templ <_region_array> region_array;
    struct _sequence_array;
    typedef pointer_templ <_sequence_array> sequence_array;
    struct _layer_array;
    typedef pointer_templ <_layer_array> layer_array;
    struct _event_clip_array;
    typedef pointer_templ <_event_clip_array> event_clip_array;
    struct _event_stream_array;
    typedef pointer_templ <_event_stream_array> event_stream_array;
    struct _event_silence_array;
    typedef pointer_templ <_event_silence_array> event_silence_array;
    struct _event_var_volume_array;
    typedef pointer_templ <_event_var_volume_array> event_var_volume_array;
    struct _event_var_pitch_array;
    typedef pointer_templ <_event_var_pitch_array> event_var_pitch_array;
    struct _event_var_volume_rand_min_array;
    typedef pointer_templ <_event_var_volume_rand_min_array> event_var_volume_rand_min_array;
    struct _event_var_volume_rand_max_array;
    typedef pointer_templ <_event_var_volume_rand_max_array> event_var_volume_rand_max_array;
    struct _event_var_pitch_rand_min_array;
    typedef pointer_templ <_event_var_pitch_rand_min_array> event_var_pitch_rand_min_array;
    struct _event_var_pitch_rand_max_array;
    typedef pointer_templ <_event_var_pitch_rand_max_array> event_var_pitch_rand_max_array;
    struct _event_var_aux_gain_array;
    typedef pointer_templ <_event_var_aux_gain_array> event_var_aux_gain_array;
    struct _event_var_positional_array;
    typedef pointer_templ <_event_var_positional_array> event_var_positional_array;
    struct _event_var_pos_fall_off_array;
    typedef pointer_templ <_event_var_pos_fall_off_array> event_var_pos_fall_off_array;
    struct _event_var_pos_dist_min_array;
    typedef pointer_templ <_event_var_pos_dist_min_array> event_var_pos_dist_min_array;
    struct _event_var_pos_dist_max_array;
    typedef pointer_templ <_event_var_pos_dist_max_array> event_var_pos_dist_max_array;
    struct _event_callback_array;
    typedef pointer_templ <_event_callback_array> event_callback_array;
    struct _event_logic_and_array;
    typedef pointer_templ <_event_logic_and_array> event_logic_and_array;
    struct _event_logic_or_array;
    typedef pointer_templ <_event_logic_or_array> event_logic_or_array;
    struct _event_logic_repeat_array;
    typedef pointer_templ <_event_logic_repeat_array> event_logic_repeat_array;
    struct _play_region_action_array;
    typedef pointer_templ <_play_region_action_array> play_region_action_array;
    struct _push_region_action_array;
    typedef pointer_templ <_push_region_action_array> push_region_action_array;
    struct _pop_region_action_array;
    typedef pointer_templ <_pop_region_action_array> pop_region_action_array;
    struct _start_layer_action_array;
    typedef pointer_templ <_start_layer_action_array> start_layer_action_array;
    struct _stop_layer_action_array;
    typedef pointer_templ <_stop_layer_action_array> stop_layer_action_array;
    struct _rand_state_action_array;
    typedef pointer_templ <_rand_state_action_array> rand_state_action_array;
    struct _stream_ref_array;
    typedef pointer_templ <_stream_ref_array> stream_ref_array;
    struct _clip_ref_array;
    typedef pointer_templ <_clip_ref_array> clip_ref_array;
    struct _region_ref_array;
    typedef pointer_templ <_region_ref_array> region_ref_array;
    struct _state_ref_array;
    typedef pointer_templ <_state_ref_array> state_ref_array;
    struct _action_ref_array;
    typedef pointer_templ <_action_ref_array> action_ref_array;
    struct _action_ref_array_array;
    typedef pointer_templ <_action_ref_array_array> action_ref_array_array;
    struct _string_array;
    typedef pointer_templ <_string_array> string_array;
    struct _layer_ref_array;
    typedef pointer_templ <_layer_ref_array> layer_ref_array;
    struct _float_array;
    typedef pointer_templ <_float_array> float_array;
    struct _sequence_event_ref_array;
    typedef pointer_templ <_sequence_event_ref_array> sequence_event_ref_array;
...
// cls type comp
    ...
    inline void
    comp_event_var_volume_rand_min_array(const comp &, const event_var_volume_rand_min_array);

    inline const event_var_volume_rand_max_array comp_event_var_volume_rand_max_array(const comp &);

    inline void
    comp_event_var_volume_rand_max_array(const comp &, const event_var_volume_rand_max_array);

    inline const event_var_pitch_rand_min_array comp_event_var_pitch_rand_min_array(const comp &);

    inline void
    comp_event_var_pitch_rand_min_array(const comp &, const event_var_pitch_rand_min_array);

    inline const event_var_pitch_rand_max_array comp_event_var_pitch_rand_max_array(const comp &);

    inline void
    comp_event_var_pitch_rand_max_array(const comp &, const event_var_pitch_rand_max_array);
...
// cls type event_callback
    ...
    inline void
    event_callback_callback_name(const event_callback &, char *p_string, unsigned int len);
...
// cls type start_layer_action
    ...
    inline void
    start_layer_action_layer_name(const start_layer_action &, char *p_string, unsigned int len);
...
// cls type stop_layer_action
    ...
    inline void
    stop_layer_action_layer_name(const stop_layer_action &, char *p_string, unsigned int len);
...
//
    ...
    inline const fade_transition
    fade_transition_array_item_at(const fade_transition_array &ptr, unsigned int index);
    ...
    inline void
    stitch_transition_array_remove_item(const stitch_transition_array &, unsigned int item);

    inline const stitch_transition
    stitch_transition_array_item_at(const stitch_transition_array &ptr, unsigned int index);

    inline const stitch_transition
    stitch_transition_array_add_item(const stitch_transition_array &);
    ...
    inline const event_matrix
    event_matrix_array_item_at(const event_matrix_array &ptr, unsigned int index);
    ...
    inline const event_clip
    event_clip_array_item_at(const event_clip_array &ptr, unsigned int index);
    ...
    inline const event_stream
    event_stream_array_item_at(const event_stream_array &ptr, unsigned int index);
    ...
    inline const event_silence
    event_silence_array_item_at(const event_silence_array &ptr, unsigned int index);
    ...
    inline void
    event_var_volume_array_remove_item(const event_var_volume_array &, unsigned int item);

    inline const event_var_volume
    event_var_volume_array_item_at(const event_var_volume_array &ptr, unsigned int index);
    ...
    inline const event_var_pitch
    event_var_pitch_array_item_at(const event_var_pitch_array &ptr, unsigned int index);
    ...
    inline event_var_volume_rand_min_array
    event_var_volume_rand_min_array_delete(const event_var_volume_rand_min_array &);
    ...
    inline unsigned int
    event_var_volume_rand_min_array_num_items(const event_var_volume_rand_min_array &);

    inline void event_var_volume_rand_min_array_remove_item(const event_var_volume_rand_min_array &,
                                                            unsigned int item);

    inline const event_var_volume_rand_min
    event_var_volume_rand_min_array_item_at(const event_var_volume_rand_min_array &ptr,
                                            unsigned int index);

    inline const event_var_volume_rand_min
    event_var_volume_rand_min_array_add_item(const event_var_volume_rand_min_array &);

    inline event_var_volume_rand_max_array event_var_volume_rand_max_array_new(block *);

    inline event_var_volume_rand_max_array
    event_var_volume_rand_max_array_delete(const event_var_volume_rand_max_array &);
    ...
    inline unsigned int
    event_var_volume_rand_max_array_num_items(const event_var_volume_rand_max_array &);

    inline void event_var_volume_rand_max_array_remove_item(const event_var_volume_rand_max_array &,
                                                            unsigned int item);

    inline const event_var_volume_rand_max
    event_var_volume_rand_max_array_item_at(const event_var_volume_rand_max_array &ptr,
                                            unsigned int index);

    inline const event_var_volume_rand_max
    event_var_volume_rand_max_array_add_item(const event_var_volume_rand_max_array &);

    inline event_var_pitch_rand_min_array event_var_pitch_rand_min_array_new(block *);

    inline event_var_pitch_rand_min_array
    event_var_pitch_rand_min_array_delete(const event_var_pitch_rand_min_array &);
    ...
    inline unsigned int
    event_var_pitch_rand_min_array_num_items(const event_var_pitch_rand_min_array &);

    inline void event_var_pitch_rand_min_array_remove_item(const event_var_pitch_rand_min_array &,
                                                           unsigned int item);

    inline const event_var_pitch_rand_min
    event_var_pitch_rand_min_array_item_at(const event_var_pitch_rand_min_array &ptr,
                                           unsigned int index);

    inline const event_var_pitch_rand_min
    event_var_pitch_rand_min_array_add_item(const event_var_pitch_rand_min_array &);

    inline event_var_pitch_rand_max_array event_var_pitch_rand_max_array_new(block *);

    inline event_var_pitch_rand_max_array
    event_var_pitch_rand_max_array_delete(const event_var_pitch_rand_max_array &);
    ...
    inline unsigned int
    event_var_pitch_rand_max_array_num_items(const event_var_pitch_rand_max_array &);

    inline void event_var_pitch_rand_max_array_remove_item(const event_var_pitch_rand_max_array &,
                                                           unsigned int item);

    inline const event_var_pitch_rand_max
    event_var_pitch_rand_max_array_item_at(const event_var_pitch_rand_max_array &ptr,
                                           unsigned int index);

    inline const event_var_pitch_rand_max
    event_var_pitch_rand_max_array_add_item(const event_var_pitch_rand_max_array &);

    inline event_var_aux_gain_array event_var_aux_gain_array_new(block *);

    inline event_var_aux_gain_array
    event_var_aux_gain_array_delete(const event_var_aux_gain_array &);
    ...
    inline void
    event_var_aux_gain_array_remove_item(const event_var_aux_gain_array &, unsigned int item);

    inline const event_var_aux_gain
    event_var_aux_gain_array_item_at(const event_var_aux_gain_array &ptr, unsigned int index);

    inline const event_var_aux_gain
    event_var_aux_gain_array_add_item(const event_var_aux_gain_array &);

    inline event_var_positional_array event_var_positional_array_new(block *);

    inline event_var_positional_array
    event_var_positional_array_delete(const event_var_positional_array &);
    ...
    inline void
    event_var_positional_array_remove_item(const event_var_positional_array &, unsigned int item);

    inline const event_var_positional
    event_var_positional_array_item_at(const event_var_positional_array &ptr, unsigned int index);

    inline const event_var_positional
    event_var_positional_array_add_item(const event_var_positional_array &);

    inline event_var_pos_fall_off_array event_var_pos_fall_off_array_new(block *);

    inline event_var_pos_fall_off_array
    event_var_pos_fall_off_array_delete(const event_var_pos_fall_off_array &);
    ...
    inline unsigned int
    event_var_pos_fall_off_array_num_items(const event_var_pos_fall_off_array &);

    inline void event_var_pos_fall_off_array_remove_item(const event_var_pos_fall_off_array &,
                                                         unsigned int item);

    inline const event_var_pos_fall_off
    event_var_pos_fall_off_array_item_at(const event_var_pos_fall_off_array &ptr,
                                         unsigned int index);

    inline const event_var_pos_fall_off
    event_var_pos_fall_off_array_add_item(const event_var_pos_fall_off_array &);

    inline event_var_pos_dist_min_array event_var_pos_dist_min_array_new(block *);

    inline event_var_pos_dist_min_array
    event_var_pos_dist_min_array_delete(const event_var_pos_dist_min_array &);
    ...
    inline unsigned int
    event_var_pos_dist_min_array_num_items(const event_var_pos_dist_min_array &);

    inline void event_var_pos_dist_min_array_remove_item(const event_var_pos_dist_min_array &,
                                                         unsigned int item);

    inline const event_var_pos_dist_min
    event_var_pos_dist_min_array_item_at(const event_var_pos_dist_min_array &ptr,
                                         unsigned int index);

    inline const event_var_pos_dist_min
    event_var_pos_dist_min_array_add_item(const event_var_pos_dist_min_array &);

    inline event_var_pos_dist_max_array event_var_pos_dist_max_array_new(block *);

    inline event_var_pos_dist_max_array
    event_var_pos_dist_max_array_delete(const event_var_pos_dist_max_array &);
    ...
    inline unsigned int
    event_var_pos_dist_max_array_num_items(const event_var_pos_dist_max_array &);

    inline void event_var_pos_dist_max_array_remove_item(const event_var_pos_dist_max_array &,
                                                         unsigned int item);

    inline const event_var_pos_dist_max
    event_var_pos_dist_max_array_item_at(const event_var_pos_dist_max_array &ptr,
                                         unsigned int index);

    inline const event_var_pos_dist_max
    event_var_pos_dist_max_array_add_item(const event_var_pos_dist_max_array &);
    ...
    inline const event_callback
    event_callback_array_item_at(const event_callback_array &ptr, unsigned int index);
    ...
    inline const event_logic_and
    event_logic_and_array_item_at(const event_logic_and_array &ptr, unsigned int index);
    ...
    inline const event_logic_or
    event_logic_or_array_item_at(const event_logic_or_array &ptr, unsigned int index);
    ...
    inline event_logic_repeat_array
    event_logic_repeat_array_delete(const event_logic_repeat_array &);
    ...
    inline void
    event_logic_repeat_array_remove_item(const event_logic_repeat_array &, unsigned int item);

    inline const event_logic_repeat
    event_logic_repeat_array_item_at(const event_logic_repeat_array &ptr, unsigned int index);

    inline const event_logic_repeat
    event_logic_repeat_array_add_item(const event_logic_repeat_array &);

    inline play_region_action_array play_region_action_array_new(block *);

    inline play_region_action_array
    play_region_action_array_delete(const play_region_action_array &);
    ...
    inline void
    play_region_action_array_remove_item(const play_region_action_array &, unsigned int item);

    inline const play_region_action
    play_region_action_array_item_at(const play_region_action_array &ptr, unsigned int index);

    inline const play_region_action
    play_region_action_array_add_item(const play_region_action_array &);

    inline push_region_action_array push_region_action_array_new(block *);

    inline push_region_action_array
    push_region_action_array_delete(const push_region_action_array &);
    ...
    inline void
    push_region_action_array_remove_item(const push_region_action_array &, unsigned int item);

    inline const push_region_action
    push_region_action_array_item_at(const push_region_action_array &ptr, unsigned int index);

    inline const push_region_action
    push_region_action_array_add_item(const push_region_action_array &);
    ...
    inline void
    pop_region_action_array_remove_item(const pop_region_action_array &, unsigned int item);

    inline const pop_region_action
    pop_region_action_array_item_at(const pop_region_action_array &ptr, unsigned int index);

    inline const pop_region_action
    pop_region_action_array_add_item(const pop_region_action_array &);

    inline start_layer_action_array start_layer_action_array_new(block *);

    inline start_layer_action_array
    start_layer_action_array_delete(const start_layer_action_array &);
    ...
    inline void
    start_layer_action_array_remove_item(const start_layer_action_array &, unsigned int item);

    inline const start_layer_action
    start_layer_action_array_item_at(const start_layer_action_array &ptr, unsigned int index);

    inline const start_layer_action
    start_layer_action_array_add_item(const start_layer_action_array &);
    ...
    inline void
    stop_layer_action_array_remove_item(const stop_layer_action_array &, unsigned int item);

    inline const stop_layer_action
    stop_layer_action_array_item_at(const stop_layer_action_array &ptr, unsigned int index);

    inline const stop_layer_action
    stop_layer_action_array_add_item(const stop_layer_action_array &);
    ...
    inline void
    rand_state_action_array_remove_item(const rand_state_action_array &, unsigned int item);

    inline const rand_state_action
    rand_state_action_array_item_at(const rand_state_action_array &ptr, unsigned int index);

    inline const rand_state_action
    rand_state_action_array_add_item(const rand_state_action_array &);
    ...
    inline void
    action_ref_array_array_remove_item(const action_ref_array_array &, unsigned int item);

    inline const action_ref_array
    action_ref_array_array_item_at(const action_ref_array_array &ptr, unsigned int index);
    ...
    inline void string_array_item_at(const string_array &ptr, unsigned int index, char *p_string,
                                     unsigned int len);

    inline void
    string_array_item_at(const string_array &ptr, unsigned int index, const char *p_new_val);
    ...
    inline sequence_event_ref_array
    sequence_event_ref_array_delete(const sequence_event_ref_array &);
    ...
    inline void
    sequence_event_ref_array_remove_item(const sequence_event_ref_array &, unsigned int item);

    inline const sequence_event
    sequence_event_ref_array_item_at(const sequence_event_ref_array &ptr, unsigned int index);

    inline void sequence_event_ref_array_add_item(const sequence_event_ref_array &,
                                                  const sequence_event &ptr_item);
...
// cls type comp
    ...
    inline void comp_construct(const comp &ptr) {
        ...
        fade_transition_array_construct(
                pointer_templ<_fade_transition_array>(ptr.memory(), ptr.offset() + 128));
        stitch_transition_array_construct(
                pointer_templ<_stitch_transition_array>(ptr.memory(), ptr.offset() + 160));
        event_array_construct(pointer_templ<_event_array>(ptr.memory(), ptr.offset() + 192));
        event_matrix_array_construct(
                pointer_templ<_event_matrix_array>(ptr.memory(), ptr.offset() + 224));
        ...
        event_clip_array_construct(
                pointer_templ<_event_clip_array>(ptr.memory(), ptr.offset() + 480));
        event_stream_array_construct(
                pointer_templ<_event_stream_array>(ptr.memory(), ptr.offset() + 512));
        event_silence_array_construct(
                pointer_templ<_event_silence_array>(ptr.memory(), ptr.offset() + 544));
        event_var_volume_array_construct(
                pointer_templ<_event_var_volume_array>(ptr.memory(), ptr.offset() + 576));
        event_var_pitch_array_construct(
                pointer_templ<_event_var_pitch_array>(ptr.memory(), ptr.offset() + 608));
        event_var_volume_rand_min_array_construct(
                pointer_templ<_event_var_volume_rand_min_array>(ptr.memory(), ptr.offset() + 640));
        event_var_volume_rand_max_array_construct(
                pointer_templ<_event_var_volume_rand_max_array>(ptr.memory(), ptr.offset() + 672));
        event_var_pitch_rand_min_array_construct(
                pointer_templ<_event_var_pitch_rand_min_array>(ptr.memory(), ptr.offset() + 704));
        event_var_pitch_rand_max_array_construct(
                pointer_templ<_event_var_pitch_rand_max_array>(ptr.memory(), ptr.offset() + 736));
        event_var_aux_gain_array_construct(
                pointer_templ<_event_var_aux_gain_array>(ptr.memory(), ptr.offset() + 768));
        event_var_positional_array_construct(
                pointer_templ<_event_var_positional_array>(ptr.memory(), ptr.offset() + 800));
        event_var_pos_fall_off_array_construct(
                pointer_templ<_event_var_pos_fall_off_array>(ptr.memory(), ptr.offset() + 832));
        event_var_pos_dist_min_array_construct(
                pointer_templ<_event_var_pos_dist_min_array>(ptr.memory(), ptr.offset() + 864));
        event_var_pos_dist_max_array_construct(
                pointer_templ<_event_var_pos_dist_max_array>(ptr.memory(), ptr.offset() + 896));
        event_callback_array_construct(
                pointer_templ<_event_callback_array>(ptr.memory(), ptr.offset() + 928));
        event_logic_and_array_construct(
                pointer_templ<_event_logic_and_array>(ptr.memory(), ptr.offset() + 960));
        event_logic_or_array_construct(
                pointer_templ<_event_logic_or_array>(ptr.memory(), ptr.offset() + 992));
        event_logic_repeat_array_construct(
                pointer_templ<_event_logic_repeat_array>(ptr.memory(), ptr.offset() + 1024));
        play_region_action_array_construct(
                pointer_templ<_play_region_action_array>(ptr.memory(), ptr.offset() + 1056));
        push_region_action_array_construct(
                pointer_templ<_push_region_action_array>(ptr.memory(), ptr.offset() + 1088));
        pop_region_action_array_construct(
                pointer_templ<_pop_region_action_array>(ptr.memory(), ptr.offset() + 1120));
        start_layer_action_array_construct(
                pointer_templ<_start_layer_action_array>(ptr.memory(), ptr.offset() + 1152));
        stop_layer_action_array_construct(
                pointer_templ<_stop_layer_action_array>(ptr.memory(), ptr.offset() + 1184));
        rand_state_action_array_construct(
                pointer_templ<_rand_state_action_array>(ptr.memory(), ptr.offset() + 1216));
    }
    ...
    inline void comp_destroy(const comp &ptr) {
        ...
        fade_transition_array_destroy(
                pointer_templ<_fade_transition_array>(ptr.memory(), ptr.offset() + 128));
        stitch_transition_array_destroy(
                pointer_templ<_stitch_transition_array>(ptr.memory(), ptr.offset() + 160));
        event_array_destroy(pointer_templ<_event_array>(ptr.memory(), ptr.offset() + 192));
        event_matrix_array_destroy(
                pointer_templ<_event_matrix_array>(ptr.memory(), ptr.offset() + 224));
        ...
        event_clip_array_destroy(
                pointer_templ<_event_clip_array>(ptr.memory(), ptr.offset() + 480));
        event_stream_array_destroy(
                pointer_templ<_event_stream_array>(ptr.memory(), ptr.offset() + 512));
        event_silence_array_destroy(
                pointer_templ<_event_silence_array>(ptr.memory(), ptr.offset() + 544));
        event_var_volume_array_destroy(
                pointer_templ<_event_var_volume_array>(ptr.memory(), ptr.offset() + 576));
        event_var_pitch_array_destroy(
                pointer_templ<_event_var_pitch_array>(ptr.memory(), ptr.offset() + 608));
        event_var_volume_rand_min_array_destroy(
                pointer_templ<_event_var_volume_rand_min_array>(ptr.memory(), ptr.offset() + 640));
        event_var_volume_rand_max_array_destroy(
                pointer_templ<_event_var_volume_rand_max_array>(ptr.memory(), ptr.offset() + 672));
        event_var_pitch_rand_min_array_destroy(
                pointer_templ<_event_var_pitch_rand_min_array>(ptr.memory(), ptr.offset() + 704));
        event_var_pitch_rand_max_array_destroy(
                pointer_templ<_event_var_pitch_rand_max_array>(ptr.memory(), ptr.offset() + 736));
        event_var_aux_gain_array_destroy(
                pointer_templ<_event_var_aux_gain_array>(ptr.memory(), ptr.offset() + 768));
        event_var_positional_array_destroy(
                pointer_templ<_event_var_positional_array>(ptr.memory(), ptr.offset() + 800));
        event_var_pos_fall_off_array_destroy(
                pointer_templ<_event_var_pos_fall_off_array>(ptr.memory(), ptr.offset() + 832));
        event_var_pos_dist_min_array_destroy(
                pointer_templ<_event_var_pos_dist_min_array>(ptr.memory(), ptr.offset() + 864));
        event_var_pos_dist_max_array_destroy(
                pointer_templ<_event_var_pos_dist_max_array>(ptr.memory(), ptr.offset() + 896));
        event_callback_array_destroy(
                pointer_templ<_event_callback_array>(ptr.memory(), ptr.offset() + 928));
        event_logic_and_array_destroy(
                pointer_templ<_event_logic_and_array>(ptr.memory(), ptr.offset() + 960));
        event_logic_or_array_destroy(
                pointer_templ<_event_logic_or_array>(ptr.memory(), ptr.offset() + 992));
        event_logic_repeat_array_destroy(
                pointer_templ<_event_logic_repeat_array>(ptr.memory(), ptr.offset() + 1024));
        play_region_action_array_destroy(
                pointer_templ<_play_region_action_array>(ptr.memory(), ptr.offset() + 1056));
        push_region_action_array_destroy(
                pointer_templ<_push_region_action_array>(ptr.memory(), ptr.offset() + 1088));
        pop_region_action_array_destroy(
                pointer_templ<_pop_region_action_array>(ptr.memory(), ptr.offset() + 1120));
        start_layer_action_array_destroy(
                pointer_templ<_start_layer_action_array>(ptr.memory(), ptr.offset() + 1152));
        stop_layer_action_array_destroy(
                pointer_templ<_stop_layer_action_array>(ptr.memory(), ptr.offset() + 1184));
        rand_state_action_array_destroy(
                pointer_templ<_rand_state_action_array>(ptr.memory(), ptr.offset() + 1216));
    }
    ...
    inline const event_var_volume_rand_min_array
    comp_event_var_volume_rand_min_array(const comp &ptr) {
        return pointer_templ<_event_var_volume_rand_min_array>(ptr.memory(), ptr.offset() + 640);
    }

    inline const event_var_volume_rand_max_array
    comp_event_var_volume_rand_max_array(const comp &ptr) {
        return pointer_templ<_event_var_volume_rand_max_array>(ptr.memory(), ptr.offset() + 672);
    }

    inline const event_var_pitch_rand_min_array
    comp_event_var_pitch_rand_min_array(const comp &ptr) {
        return pointer_templ<_event_var_pitch_rand_min_array>(ptr.memory(), ptr.offset() + 704);
    }

    inline const event_var_pitch_rand_max_array
    comp_event_var_pitch_rand_max_array(const comp &ptr) {
...
// cls type group
    ...
    inline void group_construct(const group &ptr) {
        ...
        stream_ref_array_construct(
                pointer_templ<_stream_ref_array>(ptr.memory(), ptr.offset() + 64));
        clip_ref_array_construct(pointer_templ<_clip_ref_array>(ptr.memory(), ptr.offset() + 96));
        region_ref_array_construct(
                pointer_templ<_region_ref_array>(ptr.memory(), ptr.offset() + 128));
...
// cls type fade_transition
    ...
    inline void
    fade_transition_source_region_ref(const fade_transition &ptr, const region &ptr_item) {
    ...
    inline void
    fade_transition_target_region_ref(const fade_transition &ptr, const region &ptr_item) {
...
// cls type stitch_transition
    ...
    inline void
    stitch_transition_source_region_ref(const stitch_transition &ptr, const region &ptr_item) {
        ref_instance_write(pointer(ptr.memory(), ptr.offset() + 0), ptr_item);
    }
    ...
    inline void
    stitch_transition_target_region_ref(const stitch_transition &ptr, const region &ptr_item) {
        ref_instance_write(pointer(ptr.memory(), ptr.offset() + 32), ptr_item);
    }
    ...
    inline void
    stitch_transition_transition_region_ref(const stitch_transition &ptr, const region &ptr_item) {
...
// cls type event
    ...
    inline void event_construct(const event &ptr) {
        string_instance_construct(pointer(ptr.memory(), ptr.offset() + 0));
        action_ref_array_array_construct(
                pointer_templ<_action_ref_array_array>(ptr.memory(), ptr.offset() + 32));
        event_matrix_ref_construct(
                pointer_templ<_event_matrix_ref>(ptr.memory(), ptr.offset() + 64));
    }

    inline void event_destroy(const event &ptr) {
        string_instance_destroy(pointer(ptr.memory(), ptr.offset() + 0));
        action_ref_array_array_destroy(
                pointer_templ<_action_ref_array_array>(ptr.memory(), ptr.offset() + 32));
...
// cls type sequence
    ...
    inline void sequence_construct(const sequence &ptr) {
        sequence_event_ref_construct(
                pointer_templ<_sequence_event_ref>(ptr.memory(), ptr.offset() + 0));
        uint32_instance_construct(pointer(ptr.memory(), ptr.offset() + 32));
    }

    inline void sequence_destroy(const sequence &ptr) {
        sequence_event_ref_destroy(
                pointer_templ<_sequence_event_ref>(ptr.memory(), ptr.offset() + 0));
        uint32_instance_destroy(pointer(ptr.memory(), ptr.offset() + 32));
    }
...
// cls type event_var_volume_rand_min
    ...
    inline event_var_volume_rand_min event_var_volume_rand_min_new(block *p_memory) {
        event_var_volume_rand_min ptr = (event_var_volume_rand_min) block_alloc(p_memory, 64,
                                                                                "event_var_volume_rand_min");
    ...
    inline void
    event_var_volume_rand_min_volume_rand_min(const event_var_volume_rand_min &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_var_volume_rand_max
    ...
    inline event_var_volume_rand_max event_var_volume_rand_max_new(block *p_memory) {
        event_var_volume_rand_max ptr = (event_var_volume_rand_max) block_alloc(p_memory, 64,
                                                                                "event_var_volume_rand_max");
    ...
    inline void
    event_var_volume_rand_max_volume_rand_max(const event_var_volume_rand_max &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_var_pitch_rand_min
    ...
    inline event_var_pitch_rand_min event_var_pitch_rand_min_new(block *p_memory) {
        event_var_pitch_rand_min ptr = (event_var_pitch_rand_min) block_alloc(p_memory, 64,
                                                                              "event_var_pitch_rand_min");
    ...
    inline void
    event_var_pitch_rand_min_pitch_rand_min(const event_var_pitch_rand_min &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_var_pitch_rand_max
    ...
    inline event_var_pitch_rand_max event_var_pitch_rand_max_new(block *p_memory) {
        event_var_pitch_rand_max ptr = (event_var_pitch_rand_max) block_alloc(p_memory, 64,
                                                                              "event_var_pitch_rand_max");
    ...
    inline void
    event_var_pitch_rand_max_pitch_rand_max(const event_var_pitch_rand_max &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_var_aux_gain
    ...
    inline event_var_aux_gain event_var_aux_gain_new(block *p_memory) {
        event_var_aux_gain ptr = (event_var_aux_gain) block_alloc(p_memory, 96,
                                                                  "event_var_aux_gain");
...
// cls type event_var_positional
    ...
    inline event_var_positional event_var_positional_new(block *p_memory) {
        event_var_positional ptr = (event_var_positional) block_alloc(p_memory, 40,
                                                                      "event_var_positional");
...
// cls type event_var_pos_fall_off
    ...
    inline event_var_pos_fall_off event_var_pos_fall_off_new(block *p_memory) {
        event_var_pos_fall_off ptr = (event_var_pos_fall_off) block_alloc(p_memory, 64,
                                                                          "event_var_pos_fall_off");
    ...
    inline void
    event_var_pos_fall_off_pos_fall_off(const event_var_pos_fall_off &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_var_pos_dist_min
    ...
    inline event_var_pos_dist_min event_var_pos_dist_min_new(block *p_memory) {
        event_var_pos_dist_min ptr = (event_var_pos_dist_min) block_alloc(p_memory, 64,
                                                                          "event_var_pos_dist_min");
    ...
    inline void
    event_var_pos_dist_min_pos_dist_min(const event_var_pos_dist_min &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_var_pos_dist_max
    ...
    inline event_var_pos_dist_max event_var_pos_dist_max_new(block *p_memory) {
        event_var_pos_dist_max ptr = (event_var_pos_dist_max) block_alloc(p_memory, 64,
                                                                          "event_var_pos_dist_max");
    ...
    inline void
    event_var_pos_dist_max_pos_dist_max(const event_var_pos_dist_max &ptr, float value) {
        float_instance_write(pointer(ptr.memory(), ptr.offset() + 32), value);
    }
...
// cls type event_callback
    ...
    inline void
    event_callback_callback_name(const event_callback &ptr, char *p_string, unsigned int len) {
...
// cls type event_logic_and
    ...
    inline void event_logic_and_construct(const event_logic_and &ptr) {
        uint32_instance_construct(pointer(ptr.memory(), ptr.offset() + 0));
        sequence_event_ref_array_construct(
                pointer_templ<_sequence_event_ref_array>(ptr.memory(), ptr.offset() + 32));
    }

    inline void event_logic_and_destroy(const event_logic_and &ptr) {
        uint32_instance_destroy(pointer(ptr.memory(), ptr.offset() + 0));
        sequence_event_ref_array_destroy(
                pointer_templ<_sequence_event_ref_array>(ptr.memory(), ptr.offset() + 32));
    }
...
// cls type event_logic_repeat
    ...
    inline event_logic_repeat event_logic_repeat_new(block *p_memory) {
        event_logic_repeat ptr = (event_logic_repeat) block_alloc(p_memory, 128,
                                                                  "event_logic_repeat");
    ...
    inline void event_logic_repeat_construct(const event_logic_repeat &ptr) {
        ...
        uint32_instance_construct(pointer(ptr.memory(), ptr.offset() + 64));
        sequence_event_ref_construct(
                pointer_templ<_sequence_event_ref>(ptr.memory(), ptr.offset() + 96));
    }
    ...
    inline void
    event_logic_repeat_event_ref(const event_logic_repeat &ptr, const sequence_event &ptr_item) {
        ref_instance_write(pointer(ptr.memory(), ptr.offset() + 96), ptr_item);
    }
...
// cls type play_region_action
    ...
    inline play_region_action play_region_action_new(block *p_memory) {
        play_region_action ptr = (play_region_action) block_alloc(p_memory, 96,
                                                                  "play_region_action");
    ...
    inline void
    play_region_action_region_ref(const play_region_action &ptr, const region &ptr_item) {
        ref_instance_write(pointer(ptr.memory(), ptr.offset() + 32), ptr_item);
    }
...
// cls type push_region_action
    ...
    inline push_region_action push_region_action_new(block *p_memory) {
        push_region_action ptr = (push_region_action) block_alloc(p_memory, 128,
                                                                  "push_region_action");
    ...
    inline void
    push_region_action_region_ref(const push_region_action &ptr, const region &ptr_item) {
        ref_instance_write(pointer(ptr.memory(), ptr.offset() + 32), ptr_item);
    }
    ...
    inline void
    push_region_action_target_region_resume_type(const push_region_action &ptr, uint32 value) {
        uint32_instance_write(pointer(ptr.memory(), ptr.offset() + 64), value);
    }
    ...
    inline void
    push_region_action_current_region_resume_type(const push_region_action &ptr, uint32 value) {
...
// cls type start_layer_action
    ...
    inline start_layer_action start_layer_action_new(block *p_memory) {
        start_layer_action ptr = (start_layer_action) block_alloc(p_memory, 64,
                                                                  "start_layer_action");
    ...
    inline void
    start_layer_action_layer_name(const start_layer_action &ptr, char *p_string, unsigned int len) {
        string_instance_read(pointer(ptr.memory(), ptr.offset() + 32), p_string, len);
    }
...
// cls type stop_layer_action
    ...
    inline void
    stop_layer_action_layer_name(const stop_layer_action &ptr, char *p_string, unsigned int len) {
        string_instance_read(pointer(ptr.memory(), ptr.offset() + 32), p_string, len);
    }
...
#define fade_transition_array_DEFINED
    ...
    inline void
    fade_transition_array_remove_item(const fade_transition_array &ptr, unsigned int index) {
...
#define stitch_transition_array_DEFINED
    ...
    inline const stitch_transition
    stitch_transition_array_add_item(const stitch_transition_array &ptr) {
    ...
    inline void
    stitch_transition_array_remove_item(const stitch_transition_array &ptr, unsigned int index) {
...
#define event_silence_array_DEFINED
    ...
    inline void
    event_silence_array_remove_item(const event_silence_array &ptr, unsigned int index) {
...
#define event_var_volume_array_DEFINED
    ...
    inline const event_var_volume
    event_var_volume_array_add_item(const event_var_volume_array &ptr) {
    ...
    inline void
    event_var_volume_array_remove_item(const event_var_volume_array &ptr, unsigned int index) {
...
#define event_var_pitch_array_DEFINED
    ...
    inline void
    event_var_pitch_array_remove_item(const event_var_pitch_array &ptr, unsigned int index) {
...
#define event_var_volume_rand_min_array_DEFINED
    ...
    inline unsigned int
    event_var_volume_rand_min_array_num_items(const event_var_volume_rand_min_array &ptr) {
        return array_instance_num_items(ptr);
    }

    inline void
    event_var_volume_rand_min_array_construct(const event_var_volume_rand_min_array &ptr) {
        array_instance_construct(ptr, 64);
    }
    ...
    inline const event_var_volume_rand_min
    event_var_volume_rand_min_array_add_item(const event_var_volume_rand_min_array &ptr) {
        event_var_volume_rand_min ptr_new_item = (event_var_volume_rand_min) array_instance_add_item(
                ptr, 64);
    ...
    inline void
    event_var_volume_rand_min_array_destroy(const event_var_volume_rand_min_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_volume_rand_min ptr_item = (event_var_volume_rand_min) array_instance_item_at(
                    ptr, 64, i);
    ...
    inline void
    event_var_volume_rand_min_array_remove_item(const event_var_volume_rand_min_array &ptr,
                                                unsigned int index) {
        event_var_volume_rand_min ptr_item = (event_var_volume_rand_min) array_instance_item_at(ptr,
                                                                                                64,
                                                                                                index);
        event_var_volume_rand_min_destroy(ptr_item);
        ptr_item = pointer_null;
...
#define event_var_volume_rand_max_array_DEFINED
    ...
    inline unsigned int
    event_var_volume_rand_max_array_num_items(const event_var_volume_rand_max_array &ptr) {
        return array_instance_num_items(ptr);
    }

    inline void
    event_var_volume_rand_max_array_construct(const event_var_volume_rand_max_array &ptr) {
        array_instance_construct(ptr, 64);
    }
    ...
    inline const event_var_volume_rand_max
    event_var_volume_rand_max_array_add_item(const event_var_volume_rand_max_array &ptr) {
        event_var_volume_rand_max ptr_new_item = (event_var_volume_rand_max) array_instance_add_item(
                ptr, 64);
    ...
    inline void
    event_var_volume_rand_max_array_destroy(const event_var_volume_rand_max_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_volume_rand_max ptr_item = (event_var_volume_rand_max) array_instance_item_at(
                    ptr, 64, i);
    ...
    inline void
    event_var_volume_rand_max_array_remove_item(const event_var_volume_rand_max_array &ptr,
                                                unsigned int index) {
        event_var_volume_rand_max ptr_item = (event_var_volume_rand_max) array_instance_item_at(ptr,
                                                                                                64,
                                                                                                index);
        event_var_volume_rand_max_destroy(ptr_item);
        ptr_item = pointer_null;
...
#define event_var_pitch_rand_min_array_DEFINED
    ...
    inline unsigned int
    event_var_pitch_rand_min_array_num_items(const event_var_pitch_rand_min_array &ptr) {
        return array_instance_num_items(ptr);
    }

    inline void
    event_var_pitch_rand_min_array_construct(const event_var_pitch_rand_min_array &ptr) {
        array_instance_construct(ptr, 64);
    }
    ...
    inline const event_var_pitch_rand_min
    event_var_pitch_rand_min_array_add_item(const event_var_pitch_rand_min_array &ptr) {
        event_var_pitch_rand_min ptr_new_item = (event_var_pitch_rand_min) array_instance_add_item(
                ptr, 64);
    ...
    inline void event_var_pitch_rand_min_array_destroy(const event_var_pitch_rand_min_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_pitch_rand_min ptr_item = (event_var_pitch_rand_min) array_instance_item_at(
                    ptr, 64, i);
    ...
    inline void
    event_var_pitch_rand_min_array_remove_item(const event_var_pitch_rand_min_array &ptr,
                                               unsigned int index) {
        event_var_pitch_rand_min ptr_item = (event_var_pitch_rand_min) array_instance_item_at(ptr,
                                                                                              64,
                                                                                              index);
        event_var_pitch_rand_min_destroy(ptr_item);
        ptr_item = pointer_null;
...
#define event_var_pitch_rand_max_array_DEFINED
    ...
    inline unsigned int
    event_var_pitch_rand_max_array_num_items(const event_var_pitch_rand_max_array &ptr) {
        return array_instance_num_items(ptr);
    }

    inline void
    event_var_pitch_rand_max_array_construct(const event_var_pitch_rand_max_array &ptr) {
        array_instance_construct(ptr, 64);
    }
    ...
    inline const event_var_pitch_rand_max
    event_var_pitch_rand_max_array_add_item(const event_var_pitch_rand_max_array &ptr) {
        event_var_pitch_rand_max ptr_new_item = (event_var_pitch_rand_max) array_instance_add_item(
                ptr, 64);
    ...
    inline void event_var_pitch_rand_max_array_destroy(const event_var_pitch_rand_max_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_pitch_rand_max ptr_item = (event_var_pitch_rand_max) array_instance_item_at(
                    ptr, 64, i);
    ...
    inline void
    event_var_pitch_rand_max_array_remove_item(const event_var_pitch_rand_max_array &ptr,
                                               unsigned int index) {
        event_var_pitch_rand_max ptr_item = (event_var_pitch_rand_max) array_instance_item_at(ptr,
                                                                                              64,
                                                                                              index);
        event_var_pitch_rand_max_destroy(ptr_item);
        ptr_item = pointer_null;
...
#define event_var_aux_gain_array_DEFINED
    ...
    inline const event_var_aux_gain
    event_var_aux_gain_array_add_item(const event_var_aux_gain_array &ptr) {
    ...
    inline void
    event_var_aux_gain_array_remove_item(const event_var_aux_gain_array &ptr, unsigned int index) {
...
#define event_var_positional_array_DEFINED
    ...
    inline unsigned int
    event_var_positional_array_num_items(const event_var_positional_array &ptr) {
        return array_instance_num_items(ptr);
    }
    ...
    inline const event_var_positional
    event_var_positional_array_add_item(const event_var_positional_array &ptr) {
    ...
    inline void event_var_positional_array_destroy(const event_var_positional_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_positional ptr_item = (event_var_positional) array_instance_item_at(ptr, 40,
                                                                                          i);
    ...
    inline void event_var_positional_array_remove_item(const event_var_positional_array &ptr,
                                                       unsigned int index) {
        event_var_positional ptr_item = (event_var_positional) array_instance_item_at(ptr, 40,
                                                                                      index);
        event_var_positional_destroy(ptr_item);
...
#define event_var_pos_fall_off_array_DEFINED
    ...
    inline unsigned int
    event_var_pos_fall_off_array_num_items(const event_var_pos_fall_off_array &ptr) {
        return array_instance_num_items(ptr);
    }
    ...
    inline const event_var_pos_fall_off
    event_var_pos_fall_off_array_add_item(const event_var_pos_fall_off_array &ptr) {
        event_var_pos_fall_off ptr_new_item = (event_var_pos_fall_off) array_instance_add_item(ptr,
                                                                                               64);
    ...
    inline void event_var_pos_fall_off_array_destroy(const event_var_pos_fall_off_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_pos_fall_off ptr_item = (event_var_pos_fall_off) array_instance_item_at(ptr,
                                                                                              64,
                                                                                              i);
    ...
    inline void event_var_pos_fall_off_array_remove_item(const event_var_pos_fall_off_array &ptr,
                                                         unsigned int index) {
        event_var_pos_fall_off ptr_item = (event_var_pos_fall_off) array_instance_item_at(ptr, 64,
                                                                                          index);
        event_var_pos_fall_off_destroy(ptr_item);
        ptr_item = pointer_null;
        array_instance_remove_item(ptr, 64, index);
...
#define event_var_pos_dist_min_array_DEFINED
    ...
    inline unsigned int
    event_var_pos_dist_min_array_num_items(const event_var_pos_dist_min_array &ptr) {
        return array_instance_num_items(ptr);
    }
    ...
    inline const event_var_pos_dist_min
    event_var_pos_dist_min_array_add_item(const event_var_pos_dist_min_array &ptr) {
        event_var_pos_dist_min ptr_new_item = (event_var_pos_dist_min) array_instance_add_item(ptr,
                                                                                               64);
    ...
    inline void event_var_pos_dist_min_array_destroy(const event_var_pos_dist_min_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_pos_dist_min ptr_item = (event_var_pos_dist_min) array_instance_item_at(ptr,
                                                                                              64,
                                                                                              i);
    ...
    inline void event_var_pos_dist_min_array_remove_item(const event_var_pos_dist_min_array &ptr,
                                                         unsigned int index) {
        event_var_pos_dist_min ptr_item = (event_var_pos_dist_min) array_instance_item_at(ptr, 64,
                                                                                          index);
        event_var_pos_dist_min_destroy(ptr_item);
        ptr_item = pointer_null;
        array_instance_remove_item(ptr, 64, index);
...
#define event_var_pos_dist_max_array_DEFINED
    ...
    inline unsigned int
    event_var_pos_dist_max_array_num_items(const event_var_pos_dist_max_array &ptr) {
        return array_instance_num_items(ptr);
    }
    ...
    inline const event_var_pos_dist_max
    event_var_pos_dist_max_array_add_item(const event_var_pos_dist_max_array &ptr) {
        event_var_pos_dist_max ptr_new_item = (event_var_pos_dist_max) array_instance_add_item(ptr,
                                                                                               64);
    ...
    inline void event_var_pos_dist_max_array_destroy(const event_var_pos_dist_max_array &ptr) {
        unsigned int items = array_instance_num_items(ptr);
        for (unsigned int i = 0; i < items; i++) {
            event_var_pos_dist_max ptr_item = (event_var_pos_dist_max) array_instance_item_at(ptr,
                                                                                              64,
                                                                                              i);
    ...
    inline void event_var_pos_dist_max_array_remove_item(const event_var_pos_dist_max_array &ptr,
                                                         unsigned int index) {
        event_var_pos_dist_max ptr_item = (event_var_pos_dist_max) array_instance_item_at(ptr, 64,
                                                                                          index);
        event_var_pos_dist_max_destroy(ptr_item);
        ptr_item = pointer_null;
        array_instance_remove_item(ptr, 64, index);
...
#define event_callback_array_DEFINED
    ...
    inline void
    event_callback_array_remove_item(const event_callback_array &ptr, unsigned int index) {
...
#define event_logic_and_array_DEFINED
    ...
    inline void
    event_logic_and_array_remove_item(const event_logic_and_array &ptr, unsigned int index) {
...
#define event_logic_or_array_DEFINED
    ...
    inline void
    event_logic_or_array_remove_item(const event_logic_or_array &ptr, unsigned int index) {
...
#define event_logic_repeat_array_DEFINED
    ...
    inline const event_logic_repeat
    event_logic_repeat_array_add_item(const event_logic_repeat_array &ptr) {
    ...
    inline void
    event_logic_repeat_array_remove_item(const event_logic_repeat_array &ptr, unsigned int index) {
...
#define play_region_action_array_DEFINED
    ...
    inline const play_region_action
    play_region_action_array_add_item(const play_region_action_array &ptr) {
    ...
    inline void
    play_region_action_array_remove_item(const play_region_action_array &ptr, unsigned int index) {
...
#define push_region_action_array_DEFINED
    ...
    inline const push_region_action
    push_region_action_array_add_item(const push_region_action_array &ptr) {
    ...
    inline void
    push_region_action_array_remove_item(const push_region_action_array &ptr, unsigned int index) {
...
#define pop_region_action_array_DEFINED
    ...
    inline const pop_region_action
    pop_region_action_array_add_item(const pop_region_action_array &ptr) {
    ...
    inline void
    pop_region_action_array_remove_item(const pop_region_action_array &ptr, unsigned int index) {
...
#define start_layer_action_array_DEFINED
    ...
    inline const start_layer_action
    start_layer_action_array_add_item(const start_layer_action_array &ptr) {
    ...
    inline void
    start_layer_action_array_remove_item(const start_layer_action_array &ptr, unsigned int index) {
...
#define stop_layer_action_array_DEFINED
    ...
    inline const stop_layer_action
    stop_layer_action_array_add_item(const stop_layer_action_array &ptr) {
    ...
    inline void
    stop_layer_action_array_remove_item(const stop_layer_action_array &ptr, unsigned int index) {
...
#define rand_state_action_array_DEFINED
    ...
    inline const rand_state_action
    rand_state_action_array_add_item(const rand_state_action_array &ptr) {
    ...
    inline void
    rand_state_action_array_remove_item(const rand_state_action_array &ptr, unsigned int index) {
...
#define action_ref_array_array_DEFINED
    ...
    inline const action_ref_array
    action_ref_array_array_add_item(const action_ref_array_array &ptr) {
    ...
    inline void
    action_ref_array_array_remove_item(const action_ref_array_array &ptr, unsigned int index) {
...
#define sequence_event_ref_array_DEFINED
    ...
    inline void sequence_event_ref_array_add_item(const sequence_event_ref_array &ptr,
                                                  const sequence_event &ptr_item) {

...
namespace radmusic {
    ...
    void region_controller_construct(struct_region_controller *, resource_manager *,
                                     const ods::region &);
    ...
    void
    region_controller_queue_stream(struct_region_controller *, stream_graph *, bool reset_state,

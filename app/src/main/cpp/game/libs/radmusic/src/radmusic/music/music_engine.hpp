...
//-----------------------------------------------------------------------------
    ...
    void music_engine_do_region_switch(struct_music_engine *, ods::region &ptr_region,
                                       enum_region_resume_type);

    void music_engine_do_region_push(struct_music_engine *, ods::region &ptr_region,
                                     enum_region_resume_type current,
                                     enum_region_resume_type target);
    ...
    void music_engine_push_region(struct_music_engine *, ods::region &ptr_region,
                                  enum_region_resume_type *);

    void music_engine_pop_region(struct_music_engine *, ods::region *ptr_region,
                                 enum_region_resume_type *);
    ...
    music_engine_region_controller(struct_music_engine *, const ods::region &ptr_region);

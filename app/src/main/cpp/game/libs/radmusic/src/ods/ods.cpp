...
namespace ods {
    ...
    bool primitive_assemble_name(const pointer &ptr_project, const pointer &ptr_type,
                                 const pointer &ptr_object, const pointer &ptr_instance,
                                 char *p_string, unsigned int max_chars);
...
//
    ...
    typedef void         (type_format_name_fx)(const pointer &ptr_type, char *p_string,
                                               unsigned int size);

    typedef bool         (type_write_text_fx)(const pointer &ptr_project, const pointer &ptr_type,
                                              const pointer &ptr_instance, stream_info *,
                                              unsigned int indent);

    typedef bool         (type_read_text_fx)(const pointer &ptr_type, const pointer &ptr_instance,
                                             Parser &parser);

    typedef bool         (type_compare_text_fx)(const pointer &ptr_type,
                                                const pointer &ptr_instance, Parser &parser,
                                                bool *p_same);

    typedef bool         (type_assemble_name_fx)(const pointer &ptr_project,
                                                 const pointer &ptr_type,
                                                 const pointer &ptr_object,
                                                 const pointer &ptr_instance, char *p_string,
    ...
    const offset_t _project_array_array_offset =
            _project_character_offset + (sizeof(unsigned char) * 8);
    ...
    const offset_t _project_named_object_array_offset =
            _project_cls_array_offset + (sizeof(offset_t) * 8);
    ...
    const offset_t _named_object_object_ref_offset =
            _named_object_name_ref_offset + (sizeof(offset_t) * 8);
    const offset_t _named_object_type_ref_offset =
            _named_object_object_ref_offset + (sizeof(offset_t) * 8);
    ...
    pointer project_construct(block *p_m, const char *p_name) {
        ...
        block_write(true, ptr_project, _project_uint32_offset, &g_uint32_id,
                    sizeof(g_uint32_id) * 8);
        ...
        block_write(true, ptr_project, _project_string_offset, &g_string_id,
                    sizeof(g_string_id) * 8);
        block_write(true, ptr_project, _project_character_offset, &g_character_id,
                    sizeof(g_character_id) * 8);
        ...
        block_write_reference(ptr_project, _project_array_array_offset,
                              ptr_array_type_array.offset());
        ...
        block_write_reference(ptr_project, _project_named_object_array_offset,
                              ptr_named_object_array.offset());

        return ptr_project;
    }

    void project_destroy(pointer &ptr_project) {
        pointer ptr_array_type_array = block_read_reference(ptr_project,
                                                            _project_array_array_offset);
        ...
        pointer ptr_named_object_array = block_read_reference(ptr_project,
                                                              _project_named_object_array_offset);
        ...
        for (unsigned int n = 0; n < array_size(ptr_named_object_array); n++) {
            ...
            block_revoke_reference(ptr_n.memory(),
                                   ptr_n.offset() + _named_object_object_ref_offset);
        ...
        block_revoke_reference(ptr_project.memory(),
                               ptr_project.offset() + _project_array_array_offset);
        block_revoke_reference(ptr_project.memory(),
                               ptr_project.offset() + _project_cls_array_offset);
        block_revoke_reference(ptr_project.memory(),
                               ptr_project.offset() + _project_ref_array_offset);
        block_revoke_reference(ptr_project.memory(),
                               ptr_project.offset() + _project_named_object_array_offset);
    ...
    pointer project_get_built_in_type(const pointer &ptr_project, unsigned char id) {
        ...
        switch (id) {
            case g_uint32_id:
                offset = _project_uint32_offset;
                break;
            case g_bool_id:
                offset = _project_bool_offset;
                break;
            case g_float_id:
                offset = _project_float_offset;
                break;
            case g_string_id:
                offset = _project_string_offset;
                break;
            case g_character_id:
                offset = _project_character_offset;
                break;
            default:
                offset = 0xFFFFFFFF;
                rAssert(false);
    ...
    pointer project_cls_type_find_or_alloc(const pointer &ptr_project, const char *p_name) {
        ...
        if (cls_ptr == pointer_null) {
            ...
            pointer ptr_cls_type_array = block_read_reference(ptr_project,
                                                              _project_cls_array_offset);
    ...
    pointer
    project_ref_type_find_or_alloc(const pointer &ptr_project, const pointer &ptr_ref_type) {
        ...
        if (ptr_ref == pointer_null) {
            ...
            pointer ptr_ref_type_array = block_read_reference(ptr_project,
                                                              _project_ref_array_offset);
    ...
    pointer
    project_array_type_find_or_alloc(const pointer &ptr_project, const pointer &ptr_array_type) {
    ...
    void
    project_add_instance(const pointer &ptr_project, const char *p_name, const pointer &ptr_object,
                         const pointer &ptr_type) {
        pointer ptr_named_object_array = block_read_reference(ptr_project,
                                                              _project_named_object_array_offset);
        ...
        block_write_reference(ptr_named_object, _named_object_object_ref_offset,
                              ptr_object.offset());
    ...
    pointer project_instance_at(const pointer &ptr_project, unsigned int i, char *p_string,
                                unsigned int len, pointer *p_ptr_type) {
        pointer ptr_named_object_array = block_read_reference(ptr_project,
                                                              _project_named_object_array_offset);
        ...
        if (p_string != 0) {
            pointer ptr_string = block_read_reference(ptr_named_object,
                                                      _named_object_name_ref_offset);
        ...
        pointer ptr_object = block_read_reference(ptr_named_object,
                                                  _named_object_object_ref_offset);
        return ptr_object;
    }

    pointer
    project_find_instance(const pointer &ptr_project, const char *p_name, pointer *p_ptr_type) {
        pointer ptr_named_object_array = block_read_reference(ptr_project,
                                                              _project_named_object_array_offset);
        ...
        for (unsigned int i = 0; i < items; i++) {
            ...
            if (strcmp(p_name, name) == 0) {
                ...
                if (p_ptr_type != 0) {
                    *p_ptr_type = block_read_reference(ptr_named_object,
                                                       _named_object_type_ref_offset);
                }
                return ptr_object;
            }
        }
    ...
    void project_assemble_instance_name(
        ...
        for (unsigned int i = 0; i < items; i++) {
            ...
            if (ptr_instance == ptr_object) {
                ...
                pointer ptr_type = block_read_reference(ptr_named_object,
                                                        _named_object_type_ref_offset);
    ...
    bool project_write_objects_text(
        ...
        for (unsigned int o = 0; o < objects; o++) {
            ...
            pointer ptr_object = project_instance_at(ptr_project, o, object_name, 256,
                                                     &ptr_object_type);
            ...
            g_type_functions[id].p_write_text_fx(ptr_project, ptr_object_type, ptr_object, p_si,
                                                 indent);
        }
    ...
    bool project_read_objects_text(
        ...
        while (stream_read(p_si, &c, sizeof(c))) {
            p_mem = (char *) ptr_project.memory()->mem_hooks.p_realloc(p_mem, size, size + 1,
                                                                       "...temp...");
            p_mem[size] = c;
            size += 1;
        }
...
// class
    ...
    void cls_type_add_attribute(const pointer &ptr_cls_type, const char *p_name,
                                const pointer &ptr_type) {
        pointer ptr_attribute = _cls_type_attribute_create(ptr_cls_type.memory(), p_name, ptr_type);

        pointer ptr_attribute_list = block_read_reference(ptr_cls_type,
                                                          _cls_attribute_array_offset);
    ...
    void cls_type_attribute_name(const pointer &ptr_cls_type, unsigned int a, char *p_string,
                                 unsigned int size) {
        pointer ptr_attribute_list = block_read_reference(ptr_cls_type,
                                                          _cls_attribute_array_offset);
...
// cls attribute
    ...
    void _cls_type_attribute_destroy(const pointer &ptr_attribute) {
        ...
        block_revoke_reference(ptr_attribute.memory(),
                               ptr_attribute.offset() + _cls_attribute_name_offset);
        block_revoke_reference(ptr_attribute.memory(),
                               ptr_attribute.offset() + _cls_attribute_type_offset);

        block_free(ptr_attribute, _cls_attribute_end);

    }

    void _cls_type_attribute_name(const pointer &ptr_attribute, char *p_string,
...
// ref
    ...
    void ref_type_destroy(const pointer &ptr_ref_type) {
        block_revoke_reference(ptr_ref_type.memory(),
                               ptr_ref_type.offset() + _ref_type_type_offset);
...
// array
    ...
    void array_type_destroy(const pointer &ptr_array_type) {
        block_revoke_reference(ptr_array_type.memory(),
                               ptr_array_type.offset() + _array_type_type_offset);
...
// instance
    ...
    bool instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                             const pointer &ptr_instance, stream_info *p_si, unsigned int indent) {
        unsigned char id = type_id(ptr_type);

        return g_type_functions[id].p_write_text_fx(ptr_project, ptr_type, ptr_instance, p_si,
                                                    indent);
    }
    ...
    bool instance_compare_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser,
                               bool *p_same) {
        unsigned char id = type_id(ptr_type);
...
// uint32 instance
    ...
    bool uint32_instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                                    const pointer &ptr_instance, stream_info *p_si,
                                    unsigned int indent) {
    ...
    bool uint32_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance,
                                   Parser &parser) {
    ...
    bool uint32_instance_compare_text(const pointer &ptr_type, const pointer &ptr_instance,
                                      Parser &parser, bool *p_same) {
        if (!parser.IsNumber()) {
            *p_same = false;
            return log_error(0);
        }
...
// string instance
    ...
    bool string_instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                                    const pointer &ptr_instance, stream_info *p_si,
                                    unsigned int indent) {
        char string_val[256];
    ...
    bool string_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance,
                                   Parser &parser) {
        char s[256];
    ...
    bool string_instance_compare_text(const pointer &ptr_type, const pointer &ptr_instance,
                                      Parser &parser, bool *p_same) {
        char buf[2048];
...
// ref instance
    ...
    bool
    ref_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser) {
        rAssert(false);
    ...
    bool
    ref_instance_compare_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser,
                              bool *p_same) {
        rAssert(false);
...
// bool instance
    ...
    bool
    bool_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser) {
        bool val;
...
// float instance
    ...
    bool float_instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                                   const pointer &ptr_instance, stream_info *p_si,
                                   unsigned int indent) {
    ...
    bool
    float_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser) {
        if (!parser.IsNumber()) {
            return log_error(0);
        }
...
// character instance
    ...
    bool char_instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                                  const pointer &ptr_instance, stream_info *p_si,
                                  unsigned int indent) {
    ...
    bool
    char_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser) {
        char c;
...
// array instance
    ...
    bool array_instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                                   const pointer &ptr_instance, stream_info *p_si,
                                   unsigned int ind) {
    ...
    bool
    array_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser) {
        if (!parser.SkipToken("[")) {
            return log_error(0);
        }
    ...
    bool array_instance_assemble_name(
        ...
        for (unsigned int i = 0; i < items; i++) {
            ...
            if (ptr_array_item == ptr_object_search) {
                ...
                char buf[256];
                sprintf(buf, ".%d", i);
                if (g_type_functions[id].p_assemble_name_fx(ptr_project, ptr_array_type_type,
                                                            ptr_array_item, ptr_object_search, buf,
                                                            256)) {
                    strncat(p_string, buf, max_chars);
                    return true;
                }
    ...
    pointer
    array_instance_add_item(const pointer &ptr_array_instance, unsigned int item_size_in_bits) {
    ...
    void array_instance_remove_item(const ods::pointer &ptr_array_instance, unsigned int item_size,
                                    unsigned int index) {
        pointer ptr_array = block_read_reference(ptr_array_instance, 0);
    ...
    pointer array_instance_item_at(const pointer &ptr_array_instance, unsigned int item_size,
                                   unsigned int index) {
        pointer ptr_array = block_read_reference(ptr_array_instance, 0);
...
// cls instance
    ...
    bool cls_instance_write_text(const pointer &ptr_project, const pointer &ptr_type,
                                 const pointer &ptr_instance, stream_info *p_si, unsigned int ind) {
        stream_printf(p_si, "\n");
        indent(p_si, ind);
        stream_printf(p_si, "[\n");
        ...
        for (unsigned int i = 0; i < num_attributes; i++) {
            ...
            instance_write_text(ptr_project, ptr_attrib_type, ptr_attribute_instance, p_si,
                                ind + INDENT);
            stream_printf(p_si, "\n");
        }
        indent(p_si, ind);
    ...
    bool
    cls_instance_compare_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser,
                              bool *p_same) {
        if (!parser.SkipToken("[")) {
            return log_error(0);
        }
    ...
    bool
    cls_instance_read_text(const pointer &ptr_type, const pointer &ptr_instance, Parser &parser) {
        if (!parser.SkipToken("[")) {
            return log_error(0);
        }
    ...
    bool cls_instance_assemble_name(
        ...
        for (unsigned int i = 0; i < num_attributes; i++) {
            ...
            if (ptr_object_search.offset() == offset) {
                ...
                pointer ptr_attrib = pointer(ptr_parent_object.memory(),
                                             ptr_parent_object.offset() + offset);

                unsigned char id = type_id(ptr_attrib_type);

                if (g_type_functions[id].p_assemble_name_fx(ptr_project, ptr_attrib_type,
                                                            ptr_attrib, ptr_object_search, buf,
                                                            256)) {
                    strcat(p_string, buf);
                    return true;
                }
    ...
    void cls_instance_construct(const pointer &ptr_type, const pointer &ptr_inplace) {
        ...
        for (unsigned int a = 0; a < num_attributes; a++) {
            ...
            instance_construct(ptr_attribute_type,
                               pointer(ptr_inplace.memory(), ptr_inplace.offset() + pos));
    ...
    void cls_instance_destroy(const pointer &ptr_object_type, const pointer &ptr_object) {
        ...
        for (unsigned int a = 0; a < num_attributes; a++) {
            ...
            instance_destroy(ptr_attribute_type,
                             pointer(ptr_object.memory(), ptr_object.offset() + pos));

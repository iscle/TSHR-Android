...
namespace radmusic {
        ...
        if (p_se->state_fade.state == state_fade_state_init_region) {
            ...
            if (p_se->state_fade.running_time == 0xFFFFFFFF) {
                ...
                if (float_array_num_items(
                        beat_set_beats(
                                fade_transition_beat_set(p_se->state_fade.ptr_fade_transition))) ==
                    0) {
                    ...
                    if (sequence_player_state(p_sequence_player_source) ==
            ...
            unsigned int sourceStartTime = radSoundFloatToUInt(
                    fade_transition_source_start(p_se->state_fade.ptr_fade_transition));
            unsigned int sourceFadeTime = radSoundFloatToUInt(
                    fade_transition_source_time(p_se->state_fade.ptr_fade_transition));
            unsigned int targetStartTime = radSoundFloatToUInt(
                    fade_transition_target_start(p_se->state_fade.ptr_fade_transition));
            unsigned int targetFadeTime = radSoundFloatToUInt(
                    fade_transition_target_time(p_se->state_fade.ptr_fade_transition));
            ...
            if (sequence_player_state(p_sequence_player_target) == sequence_player_state_finished ||
                sequence_player_state(p_sequence_player_target) ==
    ...
    void state_fade_initialize(
        ...
        p_se->state_fade.current_target_volume =
                fade_transition_target_time(p_se->state_fade.ptr_fade_transition) == 0.0f ? 1.0f
                                                                                          : 0.0f;
    ...
    void state_fade_cancel_init(struct_music_engine *p_se) {
        ...
        if (p_se->state_fade.state == state_fade_state_init_stream ||
            p_se->state_fade.state == state_fade_state_initialized) {
            region_controller_dequeue_stream(
                    music_engine_region_controller(
                            p_se,
    ...
    void _state_fade_update_fade_volumes(struct_music_engine *p_se) {
        struct_region_controller *pTargetRc = music_engine_region_controller(p_se,
                                                                             p_se->state_fade.ptr_region_target);
        struct_region_controller *pSourceRc = music_engine_region_controller(p_se,
                                                                             p_se->state_fade.ptr_region_source);

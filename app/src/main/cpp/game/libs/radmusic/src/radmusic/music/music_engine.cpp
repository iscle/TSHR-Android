...
//-----------------------------------------------------------------------------
    ...
    typedef bool (state_set_target_region_fx)(struct_music_engine *, region &ptr_target_region,
                                              bool reset_current_region);
...
//-----------------------------------------------------------------------------
    ...
    struct_region_controller *
    music_engine_region_controller(struct_music_engine *p_se, const region &ptr_region) {
    ...
    void
    music_engine_current_region_name(struct_music_engine *p_se, char *p_string, unsigned int len) {
    ...
    bool music_engine_current_beat(struct_music_engine *p_se, float *p_beat) {
        region ptr_region_current = g_state_functions[p_se->current_state].p_current_region_fx(
                p_se);
    ...
    void _do_action_push_region(
        ...
        enum_region_resume_type crrt =
                (enum_region_resume_type) push_region_action_current_region_resume_type(
                        ptr_push_region_action);
        enum_region_resume_type trrt =
                (enum_region_resume_type) push_region_action_target_region_resume_type(
                        ptr_push_region_action);
    ...
    void _do_action_play_region(
        ...
        enum_region_resume_type rt =
                (enum_region_resume_type) play_region_action_region_resume_type(
                        ptr_play_region_action);
    ...
    void _do_action_start_layer(struct_music_engine *p_se,
                                const start_layer_action &ptr_start_layer_action) {
        char layer_nom[256];
    ...
    void _do_action_stop_layer(struct_music_engine *p_se,
                               const stop_layer_action &ptr_stop_layer_action) {
        char layer_nom[256];
    ...
    void music_engine_do_action(struct_music_engine *p_se, const action &ptr_action) {
        switch ((enum_action_type) action_type(ptr_action)) {
            case action_type_push_region:
                _do_action_push_region(p_se, (push_region_action) ptr_action);
                break;
            case action_type_pop_region:
                _do_action_pop_region(p_se, (pop_region_action) ptr_action);
                break;
            case action_type_play_region:
                _do_action_play_region(p_se, (play_region_action) ptr_action);
                break;
            case action_type_start_layer:
                _do_action_start_layer(p_se, (start_layer_action) ptr_action);
                break;
            case action_type_stop_layer:
                _do_action_stop_layer(p_se, (stop_layer_action) ptr_action);
                break;
            default:
                rAssert(false);
        };

    ...
    const char * p_file_name,)
{
    ...
    void set_attrib(const char *p_name, unsigned int i) {
        ...
        pointer attrib = cls_instance_find_attribute(peek_object_type(), peek_object(), p_name,
                                                     ptr_int);
    ...
    void set_attrib(const char *p_name, bool b) {
        ...
        pointer ptr_attrib = cls_instance_find_attribute(peek_object_type(), peek_object(), p_name,
                                                         ptr_bool_type);
    ...
    void begin_attrib_object(const char *p_attrib_name) {
        ...
        pointer ptr_attribute = cls_instance_find_attribute(peek_object_type(), peek_object(),
                                                            p_attrib_name, ptr_attribute_type);

...
namespace radmusic {
    ...
    void state_stitch_initialize(struct_music_engine *, ods::region &ptr_region_current,
    ...
    bool state_stitch_set_target_region(struct_music_engine *, ods::region &ptr_target,

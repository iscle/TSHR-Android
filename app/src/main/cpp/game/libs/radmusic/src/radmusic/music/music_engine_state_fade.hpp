...
namespace radmusic {
    ...
    void
    state_fade_initialize(struct_music_engine *, ods::region &ptr_current_region, bool reset_target,
    ...
    bool state_fade_set_target_region(struct_music_engine *, ods::region &ptr_target,

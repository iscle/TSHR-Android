...
namespace choreo {
    ...
    public:
        ...
        const rmt::Vector &GetTargetPosition() const { return m_TargetPosition; }

        void SetTargetPosition(const rmt::Vector &pos) { m_TargetPosition = pos; }

        float GetTargetOrientation() const { return m_TargetOrientation; }

        void SetTargetOrientation(float orient) { m_TargetOrientation = orient; }

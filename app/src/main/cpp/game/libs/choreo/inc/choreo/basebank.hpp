...
//---------------------------------------------------------------------------
    ...
    typedef void (*FindHook)(const BaseBank *bank, const std::type_info &typeInfo, const char *name,
                             tUID uid, void *context);
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual Rig *GetRig() const { return m_StoreBank->GetRig(); }

        virtual IRefCount *Find(radLoadInventory::SafeCastBase &safeCaster, tUID uid) const;

        virtual void Store(tEntity *entity);

        virtual BaseBank::RawIterator *NewRawIterator() { return m_StoreBank->NewRawIterator(); }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual Rig *GetRig() const { return 0; }

        tEntityStore *GetEntityStore() const { return m_EntityStore; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        tInventory *GetInventory() const { return m_Inventory; }

...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual float GetJointWeight(int jointIndex) const { return m_Weight; }

        virtual int GetJointPriority(int jointIndex) const { return m_Priority; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        int GetMaxPartitionCount() const { return m_MaxEntryCount; }

        int GetPartitionCount() const { return m_EntryCount; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        bool
        AddJointRange(tUID jointMinUID, tUID jointMaxUID, float weight = 1.0f, int priority = 0);
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        int GetActiveJointCount() const { return m_ActiveJointCount; }
        ...
        float GetLastActiveJointWeight() const { return m_LastActiveJointWeight; }

...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual unsigned GetPosition() const { return m_Position; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        void RequiredParamString(const char *identifier, char *stringVal, int stringLen,
                                 int *lineNo = 0);
        ...
        static ErrorHandler GetErrorHandler() { return m_ErrorHandler; }

        static void *GetErrorHandlerContext() { return m_ErrorHandlerContext; }

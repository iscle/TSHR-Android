...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual const char *GetName() const { return m_Animation.GetName(); }

        PURE3D_ANIMATION *GetAnimation() { return m_Animation.GetAnimation(); }

        virtual float GetFrameCount() const { return m_Animation.GetFrameCount(); }

        virtual float GetFramesPerSecond() const { return m_Animation.GetFramesPerSecond(); }

        virtual float GetCycleStart() const { return m_FootInfo->GetCycleStart(); }

        virtual float GetFootPlant(int foot) const { return m_FootInfo->GetFootPlant(foot); }

        virtual float GetFootLift(int foot) const { return m_FootInfo->GetFootLift(foot); }

        virtual float GetFootScale(int foot) const { return m_FootInfo->GetFootScale(foot); }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        // rig accessor
        Rig *GetRig() const { return m_Blend->GetRig(); }

        // animation count information
        int GetDirectionCount() const { return m_DirectionCount; }

        int GetVelocityCount() const { return m_VelocityCount; }

        // per joint partition/priority info
        Partition *GetPartition() const { return m_Blend->GetPartition(); }

        void SetPartition(Partition *partition) { m_Blend->SetPartition(partition); }

        // weight & priority
        float GetWeight() const { return m_Blend->GetWeight(); }

        void SetWeight(float weight) { m_Blend->SetWeight(weight); }

        int GetPriority() const { return m_Blend->GetPriority(); }

        void SetPriority(int priority) { m_Blend->SetPriority(priority); }
        ...
        // root blend times
        float GetRootBlendInTime() const { return m_Blend->GetRootBlendInTime(); }

        void SetRootBlendInTime(float rootBlendInTime) {
            m_Blend->SetRootBlendInTime(rootBlendInTime);
        }

        float GetRootBlendOutTime() const { return m_Blend->GetRootBlendOutTime(); }
        ...
        // pose blend times
        float GetBlendInTime() const { return m_Blend->GetBlendInTime(); }

        void SetBlendInTime(float blendInTime) { m_Blend->SetBlendInTime(blendInTime); }

        float GetBlendOutTime() const { return m_Blend->GetBlendOutTime(); }

        void SetBlendOutTime(float blendOutTime) { m_Blend->SetBlendOutTime(blendOutTime); }
        ...
        // turning velocity
        float GetTurningVelocity() const { return m_TurningVelocity; }

        void SetTurningVelocity(float turningVelocity) { m_TurningVelocity = turningVelocity; }

        // transition accessors
        int GetTransitionCount() const { return m_TransitionCount; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        // locomotion accessor
        Locomotion *GetLocomotion() const { return m_Locomotion; }
        ...
        float GetDesiredMotionAngle() const { return m_DesiredMotionAngle; }
        ...
        float GetDesiredFacingAngle() const { return m_DesiredFacingAngle; }
        ...
        float GetActualAcceleration() const { return m_ActualAcceleration; }
        ...
        // LOD accessors
        float GetBlendThreshold() const { return m_BlendDriver->GetBlendThreshold(); }

        void SetBlendThreshold(float blendThreshold) {
            m_BlendDriver->SetBlendThreshold(blendThreshold);
        }

        int GetMaxBlendedSlotCount() const { return m_BlendDriver->GetMaxBlendedSlotCount(); }
        ...
        bool IsRootDriverEnabled() const { return m_IsRootDriverEnabled; }

        void SetIsRootDriverEnabled(bool isEnabled) { m_IsRootDriverEnabled = isEnabled; }

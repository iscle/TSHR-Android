...
//----------------------------------------------------------------------
    ...
    public:
        ...
        const poser::Transform &GetParentTransform() const { return m_ParentTransform; }

        const poser::Transform &GetPrevRootTransform() const { return m_PrevRootTransform; }
        ...
        const rmt::Vector &GetPrevPosition() const { return m_PrevRootTransform.GetTranslation(); }
        ...
        const rmt::Vector &GetGroundPoint() const { return m_GroundPoint; }

        bool IsGroundPointSet() const { return m_IsGroundPointSet; }

        void SetIsGroundPointSet(bool isGroundPointSet) { m_IsGroundPointSet = isGroundPointSet; }
        ...
        // velocity accessors
        const rmt::Vector &GetVelocity() const { return m_Velocity; }

        void SetVelocity(const rmt::Vector &velocity) { m_Velocity = velocity; }
        ...
        virtual int GetMinimumJointIndex() const { return m_RootJointIndex; }
...
//----------------------------------------------------------------------
    ...
    public:
        ...
        virtual int GetMinimumJointIndex() const { return m_RootBlender->GetMinimumJointIndex(); }

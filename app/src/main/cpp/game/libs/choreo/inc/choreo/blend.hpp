...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual float GetCycleStart() const { return 0.0f; }

        float FrameToPhase(float frame) const;

        float PhaseToFrame(float phase) const;

        virtual float GetFootPlant(int foot) const { return 0.0f; }

        virtual float GetFootLift(int foot) const { return 0.0f; }

        virtual float GetFootScale(int foot) const { return 0.0f; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        float GetCycleStart() const { return m_CycleStart; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        int GetParamCount() const { return m_Blend->GetParamCount(); }

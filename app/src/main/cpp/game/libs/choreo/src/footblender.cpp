...
namespace choreo {
    ...
    FootBlender::FootBlender(Rig *rig,
        ...
        if (orientOffsetIndex >= 0) {
            ...
            if (pvIndex >= 0) {
                ...
                m_ApplyOrientOffsetPoleVector = (pvJoint->parentIndex ==
                                                 m_RigLeg->GetEffectorJointIndex());
            } else {
    ...
    void FootBlender::UpdateEffectorTranslateDriver(FootBlendDriver *footDriver,
        ...
        BlendDriverNoContext
                <rmt::Vector, FootBlendDriver>(footDriver,
                                               &FootBlendDriver::GetFootEffectorTranslation,
                                               footWeight, footPriority,
                                               m_EffectorTranslatePriorities,
                                               m_MaxBlendedPriorities,
    ...
    void FootBlender::UpdatePoleVectorTranslateDriver(FootBlendDriver *footDriver,
        ...
        BlendDriverNoContext
                <rmt::Vector, FootBlendDriver>(footDriver,
                                               &FootBlendDriver::GetFootPoleVectorTranslation,
                                               footWeight,
                                               footPriority,
                                               m_PoleVectorTranslatePriorities,
                                               m_MaxBlendedPriorities,
    ...
    void FootBlender::UpdateEffectorRotateDriver(FootBlendDriver *footDriver,
                                                 ...
                                                 int footPriority) {
        BlendDriverNoContext
                <rmt::Quaternion, FootBlendDriver>(footDriver,
                                                   &FootBlendDriver::GetFootEffectorRotation,
                                                   footWeight, footPriority,
                                                   m_EffectorRotatePriorities,
                                                   m_MaxBlendedPriorities,
    ...
    void FootBlender::UpdateFootPlantDriver(FootBlendDriver *footDriver,
                                            ...
                                            int footPriority) {
        BlendDriverNoContext
                <float, FootBlendDriver>(footDriver, &FootBlendDriver::GetFootPlanted, footWeight,
                                         footPriority,
                                         m_FootPlantPriorities, m_MaxBlendedPriorities,
    ...
    void FootBlender::UpdateGroundFixupDriver(FootBlendDriver *footDriver,
                                              ...
                                              int footPriority) {
        BlendDriverNoContext
                <float, FootBlendDriver>(footDriver, &FootBlendDriver::GetFootGroundFixup,
                                         footWeight, footPriority,
                                         m_GroundFixupPriorities, m_MaxBlendedPriorities,

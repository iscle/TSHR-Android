...
//---------------------------------------------------------------------------
    ...
    bool Animation::ReadFromScript(ScriptReader *script,
        ...
        if ((groundFixup < 0) || (groundFixup >= 4)) {
            script->SetErrorFormat(lineNo,
                                   "Invalid groundFixup value; must be one of -1, 0, 1 or 2.");
        }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        // frame information
        float GetPreviousFrame() const { return m_PreviousFrame; }

        void SetPreviousFrame(float previousFrame) { m_PreviousFrame = previousFrame; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        float GetPreviousFrame() const { return m_AnimationFrame->GetPreviousFrame(); }

        float GetCurrentFrame() const { return m_AnimationFrame->GetCurrentFrame(); }
        ...
        void SetHasRootTranslation(bool isEnabled) { m_HasRootTranslation = isEnabled; }
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        float GetFrame() const { return m_AnimationFrame->GetCurrentFrame(); }
...
//---------------------------------------------------------------------------
    ...
    void AnimationDriver::SetStartFrame(float startFrame) {
        m_StartFrame = Animation::MakeValidFrame(startFrame, 0.0f, GetFrameCount() - 1.0f,
                                                 IsCyclic());
    }

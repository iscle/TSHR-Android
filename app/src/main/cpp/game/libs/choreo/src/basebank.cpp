...
//---------------------------------------------------------------------------
    ...
    IRefCount *
    P3DEntityStoreWrapperBank::Find(radLoadInventory::SafeCastBase &safeCaster, tUID uid) const {
...
//---------------------------------------------------------------------------
    ...
    IRefCount *
    P3DInventoryWrapperBank::Find(radLoadInventory::SafeCastBase &safeCaster, tUID uid) const {

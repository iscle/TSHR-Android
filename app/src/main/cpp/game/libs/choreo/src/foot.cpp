...
//---------------------------------------------------------------------------
    ...
    void
    FootEffectorPositionController::GetFootEffectorTranslation(rmt::Vector &effTranslate) const {
...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        // blending
        virtual float GetFootBlendInTime() const { return m_FootController->GetFootBlendInTime(); }

        virtual float
        GetFootBlendOutTime() const { return m_FootController->GetFootBlendOutTime(); }

        // weight & priority
        virtual float GetFootWeight() const { return m_FootController->GetFootWeight(); }

        virtual int GetFootPriority() const { return m_FootController->GetFootPriority(); }

        // effector
        virtual bool
        HasFootEffectorTranslation() const { return m_FootController->HasFootEffectorTranslation(); }
        ...
        virtual bool
        HasFootEffectorRotation() const { return m_FootController->HasFootEffectorRotation(); }
        ...
        // pole vector
        virtual bool
        HasFootPoleVectorTranslation() const { return m_FootController->HasFootPoleVectorTranslation(); }
        ...
        // plant
        virtual bool HasFootPlanted() const { return m_FootController->HasFootPlanted(); }

        virtual bool IsFootPlanted() const { return m_FootController->IsFootPlanted(); }

        // ground fixup
        virtual bool HasFootGroundFixup() const { return m_FootController->HasFootGroundFixup(); }

        virtual float GetFootGroundFixup() const { return m_FootController->GetFootGroundFixup(); }

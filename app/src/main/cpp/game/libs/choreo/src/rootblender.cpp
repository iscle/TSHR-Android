...
//----------------------------------------------------------------------
    ...
    void RootBlender::UpdateDriverTranslation(RootBlendDriver *rootDriver,
        ...
        BlendDriverWithContext
                <rmt::Vector, const poser::Transform &, RootBlendDriver>(m_RootTransform,
                                                                         rootDriver,
                                                                         &RootBlendDriver::GetRootTranslation,
                                                                         rootWeight,
                                                                         rootPriority,
    ...
    void RootBlender::UpdateDriverRotation(RootBlendDriver *rootDriver,
                                           ...
                                           int rootPriority) {
        BlendDriverWithContext
                <rmt::Quaternion, const poser::Transform &, RootBlendDriver>(m_RootTransform,
                                                                             rootDriver,
                                                                             &RootBlendDriver::GetRootRotation,
                                                                             rootWeight,
                                                                             rootPriority,
                                                                             m_RotatePriorities,
                                                                             m_MaxBlendedPriorities,
    ...
    void RootBlender::UpdateDriverGroundFixup(RootBlendDriver *rootDriver,
        ...
        BlendDriverNoContext
                <float, RootBlendDriver>(rootDriver, &RootBlendDriver::GetRootGroundFixup,
                                         rootWeight, rootPriority,

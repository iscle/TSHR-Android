...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        virtual void Reset(RootBlender *rootBlender) { m_RootController->Reset(rootBlender); }

        // blend times
        virtual float GetRootBlendInTime() const { return m_RootController->GetRootBlendInTime(); }

        virtual float
        GetRootBlendOutTime() const { return m_RootController->GetRootBlendOutTime(); }

        // weight & priority
        virtual float GetRootWeight() const { return m_RootController->GetRootWeight(); }

        virtual int GetRootPriority() const { return m_RootController->GetRootPriority(); }

        // translation
        virtual bool HasRootTranslation() const { return m_RootController->HasRootTranslation(); }
        ...
        // rotation
        virtual bool HasRootRotation() const { return m_RootController->HasRootRotation(); }
        ...
        // ground fixup
        virtual bool HasRootGroundFixup() const { return m_RootController->HasRootGroundFixup(); }

        virtual float GetRootGroundFixup() const { return m_RootController->GetRootGroundFixup(); }

...
//    P3DASSERT(m_JointDriverCount <DEFAULT_MAX_DRIVER_COUNT);
    ...
    void JointBlender::UpdateDriverTranslation(int jointIndex,
        ...
        BlendDriverWithContext
                <rmt::Vector, int, JointBlendDriver>(jointIndex, jointDriver,
                                                     &JointBlendDriver::GetJointTranslation,
                                                     jointWeight,
                                                     jointPriority,
                                                     m_TranslatePriorities,
                                                     DEFAULT_MAX_BLENDED_PRIORITIES,
    ...
    void JointBlender::UpdateDriverRotation(int jointIndex,
                                            ...
                                            int jointPriority) {
        BlendDriverWithContext
                <rmt::Quaternion, int, JointBlendDriver>(jointIndex, jointDriver,
                                                         &JointBlendDriver::GetJointRotation,
                                                         jointWeight,
                                                         jointPriority,
                                                         m_RotatePriorities,
                                                         DEFAULT_MAX_BLENDED_PRIORITIES,
    ...
    void JointBlender::UpdateGroupDriverTranslation(tUID group,
                                                    ...
                                                    int jointPriority) {
        BlendDriverWithContext
                <rmt::Vector, tUID, JointBlendDriver>(group, jointDriver,
                                                      &JointBlendDriver::GetGroupTranslation,
                                                      jointWeight,
                                                      jointPriority,
                                                      m_TranslatePriorities,
                                                      DEFAULT_MAX_BLENDED_PRIORITIES,
    ...
    void JointBlender::UpdateGroupDriverRotation(tUID group,
                                                 ...
                                                 int jointPriority) {
        BlendDriverWithContext
                <rmt::Quaternion, tUID, JointBlendDriver>(group, jointDriver,
                                                          &JointBlendDriver::GetGroupRotation,
                                                          jointWeight,
                                                          jointPriority,
                                                          m_RotatePriorities,
                                                          DEFAULT_MAX_BLENDED_PRIORITIES,

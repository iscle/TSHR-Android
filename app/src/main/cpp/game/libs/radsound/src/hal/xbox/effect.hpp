...
public:
    ...
    virtual unsigned int GetInput(unsigned int index) {
        rAssert(index < m_NumInputs);
        return m_pInputs[index];
    }

    virtual unsigned int GetOutput(unsigned int index) {
        rAssert(index < m_NumOutputs);
        return m_pOutputs[index];
    }
...
public:
    ...
    virtual unsigned int GetInput(unsigned int index) {
        return radSoundHalEffectXBox::GetInput(index);
    }

    virtual unsigned int GetOutput(unsigned int index) {
        return radSoundHalEffectXBox::GetOutput(index);
    }

...
public:
    ...
    void CalculatePositionalInformation(
            radSoundHalPositionalInformation *pRadSoundHalPositionalInformation);
...
private:
    ...
    void CalculatePositionalPanFactor(const radSoundHalPositionalInformation *pRsspi,
                                      float *pLeftRightPan, float *pFrontBackPan);

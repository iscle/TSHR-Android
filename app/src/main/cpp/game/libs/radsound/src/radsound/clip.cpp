...
template<> radSoundClip * radLinkedClass< radSoundClip >::s_pLinkedClassHead = nullptr;
template<> radSoundClip * radLinkedClass< radSoundClip >::s_pLinkedClassTail = nullptr;

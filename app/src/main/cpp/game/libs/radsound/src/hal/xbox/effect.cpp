...
unsigned long radSoundHalEffectDistortionXBox::s_pOutputs[] = {DSMIXBIN_FRONT_LEFT,
                                                               DSMIXBIN_FRONT_RIGHT};
...
void radSoundHalEffectXBox::SetEffectData(unsigned int dataOffset, unsigned long dataValue) {
    ...
    pIDirectSound->SetEffectData(m_EffectIndex, dataOffset, &dataValue, sizeof(unsigned long),
                                 DSFX_DEFERRED);
}
...
void
radSoundHalEffectDistortionXBox::SetPreFilterCoefficient(IIR2FilterCoefficient coef, float value) {
...
void
radSoundHalEffectDistortionXBox::SetPostFilterCoefficient(IIR2FilterCoefficient coef, float value) {
    ::radSoundVerifyAnalogPan(value);
    unsigned long hardwareValue = ::radSoundEffectAnalogToHardware(value);
    unsigned int index = 0;
    switch (coef) {
...
::radSoundHalEffectI3DL2ReverbXBoxCreate(radMemoryAllocator allocator) {
    return new("radSoundHalEffectI3DL2ReverbXBox", allocator) radSoundHalEffectI3DL2ReverbXBox(
            I3DL2_CHAIN_I3DL2_REVERB);
}
...
::radSoundHalEffectDistortionXBoxCreate(radMemoryAllocator allocator) {
    return new("radSoundHalEffectDistortionXBox", allocator) radSoundHalEffectDistortionXBox(
            DISTORTION_CHAIN_DISTORTION);
}

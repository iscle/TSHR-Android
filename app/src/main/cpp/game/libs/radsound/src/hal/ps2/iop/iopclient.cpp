...
radSoundIopPs2::radSoundIopPs2(unsigned int transferBufferSize,
    ...
    ::memset(&g_RadSoundIopVoiceServerFx_WriteVoiceState_Params_Sending, 0,
             sizeof(g_RadSoundIopVoiceServerFx_WriteVoiceState_Params_Sending));
    ::memset(&g_RadSoundIopVoiceServerFx_WriteVoiceState_Params_Current, 0,
             sizeof(g_RadSoundIopVoiceServerFx_WriteVoiceState_Params_Current));
    ::memset(&g_RadSoundEeVoiceServerFx_ReadVoiceState_Params_Receiving, 0,
             sizeof(g_RadSoundEeVoiceServerFx_ReadVoiceState_Params_Receiving));
    ::memset(&g_RadSoundEeVoiceServerFx_ReadVoiceState_Params_Current, 0,
             sizeof(g_RadSoundEeVoiceServerFx_ReadVoiceState_Params_Current));
...
void radSoundIopPs2::BindToIopLoadServer(unsigned int clearBufferSize) {
    ...
    rAssertMsg(g_IopLoadServerFxRetBuffer.m_Initialize.m_InitializedOk == 1,
               "Failed to initialize Iop module");

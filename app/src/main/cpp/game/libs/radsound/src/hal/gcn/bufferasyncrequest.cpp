...
void radSoundBufferAsyncRequestGcn::DmaToAram
    ...
    m_xIRadMemorySpaceCopyRequest = ::radMemorySpaceCopyAsync(
            (void *) aramAddress, radMemorySpace_Aram, (void *) mainMemoryAddress,
            radMemorySpace_Main, numberOfBytes);
}
...
/* static */ void radSoundBufferAsyncRequestGcn::Initialize
    ...
    rAssertMsg(s_pMainMemoryTransferBuffer != NULL,
               "radsound: Failed to allocate main memory transfer buffer");
    rAssertMsg(s_pMainMemoryInterleaveBuffer != NULL,
               "radsound: Failed to allocator main memory interleave buffer");
}
...
/* static */ void
radSoundBufferAsyncRequestGcn::CancelAsyncOperations(IRefCount *pIRefCount_Owner) {
    radSoundBufferAsyncRequestGcn *pSearch = s_pRequestHead;

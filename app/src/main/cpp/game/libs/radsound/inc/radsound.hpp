...
IRadSoundRsdFileDataSource *
radSoundRsdFileDataSourceCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);

IRadSoundBufferedDataSource *
radSoundBufferedDataSourceCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);

IRadSoundStitchedDataSource *
radSoundStitchedDataSourceCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);

IRadSoundMemoryDataSource *
radSoundMemoryDataSourceCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);

IRadSoundMemorySpaceObject *
radSoundMemorySpaceObjectCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);

IRadSoundDataCache *radSoundDataCacheCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);

IRadSoundAdpcmDecodeStream *
radSoundAdpcmDecodeStreamCreate(radMemoryAllocator = RADMEMORY_ALLOC_DEFAULT);
...
struct IRadSoundClip : public IRefCount {
    ...
    enum State {
        NoFile, Initializing, Initialized
    };
...
struct IRadSoundClipPlayer : public IRadSoundPlayer {
    ...
    enum State {
        NoClip, Queueing, QueuedPlay, Playing, Stopped
    };
...
struct IRadSoundStreamPlayer : public IRadSoundPlayer {
    enum State {
        NoSource, Queueing, QueuedPlay, Playing, Paused
    };
...
struct IRadSoundDataCache : public IRefCount {
    enum State {
        Idle, Initializing, Initialized, Error
    };

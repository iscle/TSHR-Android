...
namespace poser {
    ...
    public:
        ...
        const Joint *GetParentJoint() const { return m_ParentJoint; }

        void SetParentJoint(Joint *parent) { m_ParentJoint = parent; }

        int GetChildJointCount() const { return m_ChildJointCount; }
        ...
        const rmt::Matrix &GetObjectMatrix() const { return GetObjectTransform().GetMatrix(); }
        ...
        const rmt::Vector &
        GetObjectTranslation() const { return GetObjectTransform().GetTranslation(); }

        void SetObjectTranslation(const rmt::Vector &trans);

        const rmt::Quaternion &
        GetObjectQuaternion() const { return GetObjectTransform().GetQuaternion(); }
        ...
        const rmt::Matrix &GetWorldMatrix() const { return GetWorldTransform().GetMatrix(); }
        ...
        const rmt::Vector &
        GetWorldTranslation() const { return GetWorldTransform().GetTranslation(); }

        void SetWorldTranslation(const rmt::Vector &trans);

        const rmt::Quaternion &
        GetWorldQuaternion() const { return GetWorldTransform().GetQuaternion(); }

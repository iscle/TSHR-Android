...
// 3 element float vector (aka, a 3D posiotion)
    ...
    public:
        ...
        void Get(float *C1, float *C2, float *C3) {
            *C1 = x;
            *C2 = y;
            *C3 = z;
        }
...
// Equals(), DivideByW(), Transform()
    ...
    public:
        ...
        const Vector4 &operator=(const Vector &vector) {
            x = vector.x;
            y = vector.y;
            z = vector.z;
            w = 1.0f;
        ...
        void Get(float *C1, float *C2, float *C3, float *C4) const {
            *C1 = x;
            *C2 = y;
            *C3 = z;
            *C4 = w;
        ...
        void Set(float C1, float C2, float C3, float C4 = 1.0f) {
            x = C1;
            y = C2;
            z = C3;
            w = C4;
...
inline rmt::Vector operator*(float f, const rmt::Vector &a) {
    return rmt::Vector(f * a.x, f * a.y, f * a.z);
}

inline rmt::Vector operator*(const rmt::Vector &a, float f) {
    return rmt::Vector(f * a.x, f * a.y, f * a.z);
}
...
inline rmt::Vector operator/(const rmt::Vector &a, float f) {
    return rmt::Vector(a.x / f, a.y / f, a.z / f);
}

inline rmt::Vector operator*(const rmt::Vector &a, const rmt::Vector &b) {
    return rmt::Vector(a.x * b.x, a.y * b.y, a.z * b.z);
}

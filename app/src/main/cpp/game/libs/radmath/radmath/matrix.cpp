...
// useful for billboard type operations
    ...
    void Matrix::Invert(void) {
        ...
        if (Epsilon(det, 1.0f)) {
            ...
            tmp.m[3][0] = -((m[3][0] * tmp.m[0][0]) + (m[3][1] * tmp.m[1][0]) +
                            (m[3][2] * tmp.m[2][0]));
            tmp.m[3][1] = -((m[3][0] * tmp.m[0][1]) + (m[3][1] * tmp.m[1][1]) +
                            (m[3][2] * tmp.m[2][1]));
            tmp.m[3][2] = -((m[3][0] * tmp.m[0][2]) + (m[3][1] * tmp.m[1][2]) +
                            (m[3][2] * tmp.m[2][2]));
            tmp.m[3][3] = m[3][3];
            *this = tmp;
    ...
    void Matrix::Mult(const Matrix &a, const Matrix &b) {
        ...
        m[3][0] = (a.m[3][0] * b.m[0][0]) + (a.m[3][1] * b.m[1][0]) + (a.m[3][2] * b.m[2][0]) +
                  b.m[3][0];
        m[3][1] = (a.m[3][0] * b.m[0][1]) + (a.m[3][1] * b.m[1][1]) + (a.m[3][2] * b.m[2][1]) +
                  b.m[3][1];
        m[3][2] = (a.m[3][0] * b.m[0][2]) + (a.m[3][1] * b.m[1][2]) + (a.m[3][2] * b.m[2][2]) +
                  b.m[3][2];
        m[3][3] = 1.0f;

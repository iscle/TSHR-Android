...
namespace sim {
    ...
    public:
        ...
        Collision(CollisionVolume *a, const rmt::Vector &pa, CollisionVolume *b,
                  const rmt::Vector &pb, float dist, const rmt::Vector &n);

        ~Collision() {}

        void
        Set(CollisionVolume *a, const rmt::Vector &pa, CollisionVolume *b, const rmt::Vector &pb,
            float dist, const rmt::Vector &n);
        ...
        SimulatedObject *GetSimulatedObjectA() {
            return mCollisionObjectA->GetSimState()->GetSimulatedObject(mIndexA);
        }

        SimulatedObject *GetSimulatedObjectB() {
            return mCollisionObjectB->GetSimState()->GetSimulatedObject(mIndexB);
        }
...
//
    ...
    public:
        ...
        bool Contains(CollisionObject *obj) const {
            return mObjectA == obj || mObjectB == obj ? true : false;
        }
        ...
        float UpApproxSpeedMagnitude() const {
            return mObjectA->GetSimState()->UpApproxSpeedMagnitude() +
                   mObjectB->GetSimState()->UpApproxSpeedMagnitude();
        }

...
//#define DRAW_ALL_BBOX
    ...
    void DrawBBox(CollisionVolume *volume) {
        ...
        dBox3(volume->mPosition, volume->mBoxSize,
              tColour(rmt::Min(255, 25 * colorScale), 0, rmt::Max(0, 255 - 25 * colorScale)));
    }
...
#ifndef RAD_RELEASE
        P3DDrawSphere(el->GetRadius() * sDrawVolumeShapeScale, el->mPosition, *defaultShader,
                      el->GetColour());
#endif

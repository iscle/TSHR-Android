...
namespace sim {
    ...
    CollisionAnalyserData::CollisionAnalyserData()
        ...
        if (mPossibleEvent &
            (cCollisionAnalyserPossibleEventSliding | cCollisionAnalyserPossibleEventRolling)) {
    ...
    void CollisionAnalyserData::CalculateState(void) {
        ...
        if (timeDiff > mInfo.mBounceTimeThreshold ||
            ...
            if (mPossibleEvent & cCollisionAnalyserPossibleEventInteracting) {
                ...
                CollisionAnalyserPossibleEvent doCalc = mPossibleEvent &
                                                        (cCollisionAnalyserPossibleEventSliding |
                                                         cCollisionAnalyserPossibleEventRolling);
                if (doCalc) {
                    if (doCalc == (cCollisionAnalyserPossibleEventSliding |
                                   cCollisionAnalyserPossibleEventRolling)) {
    ...
    void CollisionAnalyserData::AddEvent(CollisionAnalyserEventEnum newEvent,
                                         CollisionAnalyserInfo &newInfo) {
        if (ReadyToTerminate())

...
namespace sim {
    ...
    public:
        ...
        // collide two volumes
        void
        DetectCollision(CollisionVolume *volA, CollisionVolume *volB, TArray <Collision> *inCList);

        // collide many volumes
        void DetectCollision(TArray <CollisionObjectPair> *inPList, TArray <Collision> *inCList,
                             float inDt, const bool printOut);
    ...
    protected:
        ...
        void DetectBSColl(OBBoxVolume *volA, CollisionVolume *volB,
                          float radius); // OBBoxVolume vs SphereVolume
        void
        DetectColl(CylinderVolume *volA, CylinderVolume *volB); // CylinderVolume vs CylinderVolume
        void
        DetectCSColl(CylinderVolume *volA, CollisionVolume *volB); // CylinderVolume vs SphereVolume
        void
        DetectSSColl(CollisionVolume *volA, CollisionVolume *volB); // SphereVolume vs SphereVolume

...
namespace sim {
    ...
    enum RayIntersectionMethodEnum {
        RayIntersectionBSphere, RayIntersectionBBox, RayIntersectionVolume
    };
    ...
    public:
        ...
        static void
        Add(TArray <RayIntersectionInfo> &inList, RayIntersectionInfo &info, const rmt::Vector &ray,
            rmt::Vector &sray, float &rayLen);

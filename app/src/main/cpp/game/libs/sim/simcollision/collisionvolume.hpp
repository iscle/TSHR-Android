...
// base class
    ...
    public:
        ...
        bool HasSubVolume() const {
            return (mSubVolumeList == NULL || mSubVolumeList->GetSize() == 0) ? false : true;
        }
        ...
        bool ContainsBB(
                CollisionVolume *el);           // mostly for debug to make sure a sub BB is smaller than the parent
    ...
    private:
        CollisionVolume &operator=(CollisionVolume &inVolume) {
            rAssert(false);
            return *this;
        }
...
// CylinderVolume class
    ...
    public:
        CylinderVolume(const rmt::Vector &center, const rmt::Vector &o, float len, float r,
                       bool flatend = false);
...
//#define OBBoxStorePoints
    ...
    public:
        OBBoxVolume(const rmt::Vector &center, const rmt::Vector &o0, const rmt::Vector &o1,
                    const rmt::Vector &o2, float l0, float l1, float l2) {
        ...
        void Set(const rmt::Vector &center, const rmt::Vector &o0, const rmt::Vector &o1,
                 const rmt::Vector &o2, float l0, float l1, float l2);

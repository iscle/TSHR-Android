...
//
    ...
    void SimUnits::Reset() {
        rAssertMsg(sList == NULL,
                   "SimUnits::Reset: there is still some instances of SimUnits, can't reset");
        sUnitSet = false;
        sM = 1.0f;
        sL = 1.0f;
        sT = 1.0f;
    ...
    void SimEnvironment::SetCollisionDistanceCGS(float d) {
        ...
        if (SimUnits::UnitSet()) {
            ...
            if (CollisionManager::GetCurrentInstance()) {
                ...
                CollisionManager::GetCurrentInstance()->GetCollisionDetector()->SetCollisionDistance(
                        sCollisionDistance);
            }
        }
    }

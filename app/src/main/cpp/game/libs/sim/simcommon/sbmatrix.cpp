...
//
    ...
    void
    SparseBlockMatrix::modified_pcg(const float *b, /*const*/ BlockArray *Sfilter, const float *z,
                                    float *dv) {
...
// guaranty that the precontionner is positive definit. Also we do not do filtering
    ...
    void SparseBlockMatrixMonotonous::modified_pcg(const float *b, /*const*/ BlockArray *Sfilter,
                                                   const float *z, float *dv) {

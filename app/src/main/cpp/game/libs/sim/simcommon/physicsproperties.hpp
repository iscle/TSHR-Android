...
namespace sim {
    ...
    public:
        ...
        static PhysicsProperties *
        FindPhysicsProperty(const char *stringData, tEntityStore *store = NULL);
        ...
        static float CombinedRestCoeff(const PhysicsProperties *inProperties1,
                                       const PhysicsProperties *inProperties2);

        static float CombinedTangRestCoeff(const PhysicsProperties *inProperties1,
                                           const PhysicsProperties *inProperties2);

        static float CombinedFrictCoeff(const PhysicsProperties *inProperties1,
                                        const PhysicsProperties *inProperties2);

    protected:
        static PhysicsProperties *
        GetPhysicsProperties(tEntityStore *store, char *inName, float inRest, float inFrict,
                             float inTangRest, float density = 1.0f);

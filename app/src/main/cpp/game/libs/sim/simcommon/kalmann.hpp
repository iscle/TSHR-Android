...
namespace sim {
    ...
    public:
        ...
        virtual bool
        Init(const Vector *firstGuess, const Vector *measUncert, const Vector *valueUncert) = 0;
    ...
    public:
        ...
        virtual bool
        Init(const Vector *firstGuess, const Vector *measUncert, const Vector *valueUncert);
...
//
    ...
    public:
        ...
        bool Init(float firstGuess, float measUncert, float valueUncert, float frstGuess2,

...
*/
    ...
    PhysicsProperties *
    PhysicsProperties::GetPhysicsProperties(tEntityStore *store, char *inName, float inRest,
                                            float inFrict, float inTangRest, float inDensity) {
    ...
    PhysicsProperties *
    PhysicsProperties::FindPhysicsProperty(const char *stringData, tEntityStore *store) {
    ...
    PhysicsProperties *PhysicsProperties::IcyProperties(tEntityStore *store) {
        return GetPhysicsProperties(store, "icy", 1.05f, 0.0f,
                                    -1.0f); // at -1.0 for tanrest, friction is ignored.
    }

//

    float PhysicsProperties::CombinedRestCoeff(const PhysicsProperties *inProperties1,
                                               const PhysicsProperties *inProperties2) {
        return rmt::Min(inProperties1->RestCoeff(), inProperties2->RestCoeff());
    }

    float PhysicsProperties::CombinedTangRestCoeff(const PhysicsProperties *inProperties1,
                                                   const PhysicsProperties *inProperties2) {
        return Average(inProperties1->TangRestCoeff(), inProperties2->TangRestCoeff());
    }

    float PhysicsProperties::CombinedFrictCoeff(const PhysicsProperties *inProperties1,
                                                const PhysicsProperties *inProperties2) {

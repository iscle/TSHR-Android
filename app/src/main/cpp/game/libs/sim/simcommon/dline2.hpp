...
namespace sim {
    ...
    inline void dLine2(const rmt::Vector &p1, const rmt::Vector &p2, const tColour &c) {
        dLine2(p1, p2, c, c);
    }
    ...
    void
    dQuad(const rmt::Vector &p, const rmt::Vector &a, const rmt::Vector &b, const tColour &colour);
...
// used together
    ...
    void
    dStreamLine(const rmt::Vector &p1, const rmt::Vector &p2, const tColour &c1, const tColour &c2);

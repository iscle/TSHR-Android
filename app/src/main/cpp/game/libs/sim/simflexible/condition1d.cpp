...
namespace sim {
    ...
    Stretch1DCondition::Stretch1DCondition(FlexParticle *pii, FlexParticle *pjj, ConditionParams *p,
                                           float ddl, bool inUsePartialDerivative)
            : Condition(pii, pjj, p) {
        bu = 1.0f;
    ...
    void Stretch1DCondition::BuildMatrix(SparseBlockMatrix *A, float *b, float dt) {
        ...
        if (mUsePartialDerivative) {
            ...
            float Kij[3][3];
            AddLinearMatrix(dCidCj, -GetStretch1Dkf(), d2Cij,
                            -GetStretch1Dkf() * C0 - GetStretch1Dkd() * Cdot, Kij);
...
//
    ...
    Bend1DCondition::Bend1DCondition(FlexParticle *pii, FlexParticle *pjj, FlexParticle *pkk,
                                     ConditionParams *p, bool calcRestAngle,
...
//
    ...
    Wind1DCondition::Wind1DCondition(FlexParticle *pii, FlexParticle *pjj, ConditionParams *p,
                                     Vector *w)
            : Condition(pii, pjj, p),
              mWind(w) {
        float dl[3];

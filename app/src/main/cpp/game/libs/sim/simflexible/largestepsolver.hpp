...
namespace sim {
    ...
    public:
        ...
        virtual void ConstrainParticle(int index, int inNbDof, const rmt::Vector *in_dir1,
                                       const rmt::Vector *dir2);

    protected:

        void LineConstrainParticle(int n, const rmt::Vector &in_dir1, const rmt::Vector &dir2,
                                   bool inCnsVel = true);

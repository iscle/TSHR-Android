...
namespace sim {
    ...
    typedef enum {
        eLargeStepSolver = 1,
        eSemiImplicitSolver1D,
        eSemiImplicitSolver2D,
        eEulerSolver,
        eKinematicSolver,
        eUndefinedSolver
    } eParticleSystemSolverType;
    ...
    public:
        ...
        virtual void
        ConstrainParticle(int n, int inNbDof, const rmt::Vector *dir1, const rmt::Vector *dir2) {};

        // Semi-implicit solver specific:
        virtual bool NeedPrecomputation(
                void) const { return false; } //Filter have to be updated when dt and/or other stuff changed.

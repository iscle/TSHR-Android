...
namespace sim {
    ...
    public:
        ...
        void
        ResetDirectionOfConstraint();//Reset previous Direction of constraint set by AddDirectionOfConstraint
        bool AddDirectionOfConstraint(
                const rmt::Vector &inDir); //Add a new direction of constraint, return true effectively added.
        void CleanForConstraint(
                rmt::Vector *io_d) const; //Filter io_d regarding the current set of direction of constraints.

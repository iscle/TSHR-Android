...
//and FreeParticle are not.
    void LargeStepSolver::ConstrainParticle(int index, int inNbDof, const Vector *in_dir1,
                                            const Vector *in_dir2) {
    ...
    void LargeStepSolver::LineConstrainParticle(int n, const Vector &in_dir1, const Vector &in_dir2,
                                                bool inCnsVel) {
        ...
        rAssert(test >
                MILLI_EPS);//dir1 and dir2 are parallel, this case is a candidate for a 2dof constraint.

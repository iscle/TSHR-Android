...
//
    ...
    int SRS::SetGoalPos(const float eee[3], const IKMatrix E, const Vector &inRotateAxis,
                        Matrix &inRmid) {
        IKMatrix Temp;
        float s[3];
        ...
        Solve_R_angle(Vector(ee[0], ee[1], ee[2]), mS.Row(3), mT.Row(3),
                      r_angle);  // mS should be E.mS
        //if(!solve_R_angle(ee, s, p_r1, T, r_angle))
        // return 0;

...
//===========================================================================
template<class T>
inline const T &rVector<T>::operator[](long location) const {
...
//===========================================================================
template<class T>
inline T &rVector<T>::operator[](long location) {
    //rAssert(location <mSize);
...
//===========================================================================
template<class T>
inline void rVector<T>::ClearAndDestroy() {
    //rAssert(m_Capacity> 0);
...
template<class T>
inline long rVector<T>::Capacity() const {
    return m_Capacity;
}

template<class T>
inline bool rVector<T>::Empty() const {
    return (m_Size == 0);
}

template<class T>
inline void rVector<T>::Erase(T &item) {
    int i;
    for (i = 0; i < m_Size; i++) {
...
template<class T>
inline void rVector<T>::Erase(long location) {
...
template<class T>
inline void rVector<T>::Insert(T &item) {
    this->Insert(item, m_Size);
}

template<class T>
inline void rVector<T>::Insert(T &item, long location) {
...
template<class T>
inline void rVector<T>::Reserve(long number) {
...
template<class T>
inline long rVector<T>::Size() const {
    return m_Size;
}

template<class T>
inline long rVector<T>::GrowSize() const {
    return m_GrowSize;
}

template<class T>
inline void rVector<T>::SetGrowSize(long size) {
    m_GrowSize = size;
}

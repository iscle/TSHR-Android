...
//-----------------------------------------------------------------------------
LanguageEntry::LanguageEntry(const PascalCString &rid, const UnicodeString &translation,
...
bool LanguageEntry::Add(const UnicodeString &translation, const char chLanguage) {
    ...
    LanguageArray::iterator itLanguage = std::find(m_rgchLanguages.begin(), m_rgchLanguages.end(),
                                                   chLanguage);

...
*/
        ...
        virtual tFont *
        LoadFontFromBuffer(char *name, char *buffer, const int bufferSize, float fontSize) = 0;
        ...
        virtual void ApplyEffect(unsigned effectHandle,
                                 unsigned objectHandle) = 0;  // can apply effect to multiple objects

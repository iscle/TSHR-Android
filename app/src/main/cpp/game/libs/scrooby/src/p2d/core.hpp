...
//   void FreeData(char* screenName);
        ...
        virtual tFont *
        LoadFontFromBuffer(char *name, char *buffer, const int bufferSize, float fontSize);
        ...
        void ReplaceTextObject(FeText *pFeText, tFont *pFont, UnicodeChar *string,
                               unsigned oldTextObjectHandle);
        ...
        void
        ReplacePure3dObject(FeDrawable *pFeDrawable, unsigned coreHandle, tDrawable *ptDrawable);
        ...
        void ApplyEffect(unsigned effectHandle,
                         unsigned objectHandle);  // can apply effect to multiple objects
...
//===========================================================================
    ...
    public:
        ...
        SceneElementRenderProperties
        UpdateProperties(const SceneElementRenderProperties &properties);

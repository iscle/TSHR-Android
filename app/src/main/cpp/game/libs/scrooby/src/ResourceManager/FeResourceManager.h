...
public:
    ...
    int AddResource(const char *filename, FeEntity *parent, ResourceType type,
                    const char *inventoryName = NULL);
...
protected:
    ...
    public:
        ...
        // Copy constructor.
        Pure3dAttributesEntry(const Pure3dAttributesEntry &rhs) : ResourceManagerEntryBase(
                rhs) { *this = rhs; };
    };
    ...
    public:
        ...
        void SetResourceManager(
                FeResourceManager *resourcemanager) { m_pResourceManager = resourcemanager; }

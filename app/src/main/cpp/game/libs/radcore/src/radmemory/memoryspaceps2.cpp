...
IRadMemoryAllocator *
radMemorySpaceGetAllocator(radMemorySpace memorySpace, radMemoryAllocator allocator) {
...
IRadMemorySpaceCopyRequest *radMemorySpaceCopyAsync
    ...
    if (spaceDest == radMemorySpace_Ee && spaceSrc == radMemorySpace_Ee) {
        ...
        MemorySpaceAsyncRequest *pR = new(
                "MemorySpaceAsyncRequest_CopyEeToIop") MemorySpaceAsyncRequest_CopyEeToIop(pDest,
                                                                                           pSrc,
                                                                                           bytes);
        ...
        MemorySpaceAsyncRequest *pR = new(
                "MemorySpaceAsyncRequest_CopyIopToEe") MemorySpaceAsyncRequest_CopyIopToEe(pDest,
                                                                                           pSrc,
                                                                                           bytes);
        MemorySpaceAsyncRequest::QueueRequest(pR);
        return pR;
        ...
        MemorySpaceAsyncRequest *pR = new(
                "MemorySpaceAsyncRequest_CopyIopToIop") MemorySpaceAsyncRequest_CopyIopToIop(pDest,
                                                                                             pSrc,
                                                                                             bytes);
        MemorySpaceAsyncRequest::QueueRequest(pR);
        return pR;
...
MemorySpaceAsyncRequest_CopyEeToIop::MemorySpaceAsyncRequest_CopyEeToIop(
    ...
    //
    rAssertMsg((bytes & 0xf) == 0,
               "radMemoryCpyAsync: Cached reads must be a multiple of 16 bytes.");
...
MemorySpaceAsyncRequest_CopyIopToEe::MemorySpaceAsyncRequest_CopyIopToEe(
    ...
    rAssertMsg((bytes & 0xf) == 0,
               "radMemoryCopyAsync: Cached reads must be a multiple of 16 bytes.");
...
MemorySpaceAsyncRequest_CopyIopToIop::MemorySpaceAsyncRequest_CopyIopToIop
    ...
    rAssertMsg((m_BytesToCopy & 0xf) == 0,
               "radMemoryCopyAsync: Cached reads must be a multiple of 16 bytes.");

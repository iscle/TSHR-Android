...
void * radMemoryTwoWayAllocator::InternalAllocate( unsigned int size, unsigned int alignment )
{
    ...
    {
        pMemory = ( char * ) ::radMemoryRoundUp( ( unsigned int )(uintptr_t)  m_pCurrentTop, alignment );
    ...
    {
        pMemory = ( char * ) ::radMemoryRoundDown( ( unsigned int )(uintptr_t) m_pCurrentBottom - size, alignment );

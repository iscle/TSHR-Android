...
radMemoryAllocator radMemoryGetCurrentAllocator( void )
{
    ...
    //
    return( (radMemoryAllocator) (uintptr_t)g_CurrentAllocator->GetValue( ) );
}
...
radMemoryAllocator radMemorySetCurrentAllocator( radMemoryAllocator allocator )
{
    ...
    //
    radMemoryAllocator prevAllocator = (radMemoryAllocator) (uintptr_t)g_CurrentAllocator->GetValue( );

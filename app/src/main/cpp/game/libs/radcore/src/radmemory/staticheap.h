...
public:
    ...
    void AllowFreeing(
            const bool freeingAllowed);   //ONLY use this function when forcing some type of system shutdown and you don't want to see the asserts
    ...
    void GetMemoryObjectAligned(IRadMemoryObject **ppIRadMemoryObject, unsigned int size,

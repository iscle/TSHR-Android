...
public:
    FileCompletionRequest(IRadThread *pThread, radFile *pFile,
                          IRadFileCompletionCallback *pCallback, void *pUserData);
...
public:
    DriveCompletionRequest(IRadThread *pThread, radInstanceDrive *pDrive,
                           IRadDriveCompletionCallback *pCallback, void *pUserData);
...
public:
    FileReadRequest(radFile *pFile, void *pData, unsigned int bytesToRead,
...
public:
    FileWriteRequest(radFile *pFile, const void *pData, unsigned int bytesToWrite,
...
public:
    DriveFindFirstRequest(radInstanceDrive *pInstDrive, const char *searchspec,

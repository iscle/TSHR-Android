...
private:
    ...
    SplitBlockTop(ExternalMemoryObject *pEmo_FreeBlock, unsigned int size, unsigned int alignment);

    ExternalMemoryObject *SplitBlockBottom(ExternalMemoryObject *pEmo_FreeBlock, unsigned int size,
                                           unsigned int alignment);

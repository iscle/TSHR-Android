...
public:
    ...
    virtual void AddUnsignedShort(unsigned short *pValue, const char *pName, const char *pNameSpace,
                                  ...
                                  unsigned short min, unsigned short max, bool readonly);
    ...
    virtual void AddUnsignedChar(unsigned char *pValue, const char *pName, const char *pNameSpace,
                                 ...
                                 unsigned char max, bool readonly);
    ...
    virtual void AddBoolean(bool *pValue, const char *pName, const char *pNameSpace,
                            RADDEBUGWATCH_CALLBACK callback, void *userData, bool readonly);
...
private:
    ...
    WCCreate *DoCreatePacketPreamble(void *pValue, const char *pName, const char *pNameSpace,
                                     RADDEBUGWATCH_CALLBACK callback, void *userData);

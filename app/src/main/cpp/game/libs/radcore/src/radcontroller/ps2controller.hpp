...
static const char *PsxDigitalInputPoints[] =
        {
                "Select", "Start", "DPadUp", "DPadRight", "DPadDown", "DPadLeft", "L2", "R2", "L1",
                "R1", "Triangle", "Circle", "X", "Square"
        };
...
static const char *PsxDualShock2InputPoints[] =
        {
                ...
                "R1", "Triangle", "Circle", "X", "Square",
                "L3", "R3", "RightStickX", "RightStickY", "LeftStickX", "LeftStickY",
                "AnalogDPadRight", "AnalogDPadLeft", "AnalogDPadUp", "AnalogDPadDown",
                "AnalogTriangle", "AnalogCircle", "AnalogX", "AnalogSquare", "AnalogL1", "AnalogR1",
                "AnalogL2", "AnalogR2"
        };
...
struct iIControllerLocation2
    ...
    virtual bool
    ReconnectIfControllerMatches(int id, rController2 **controller, unsigned int bufferSize) = 0;
...
class rController2
        :
                ...
                public radObject {
public:
    rController2(int port, int slot, int id, IRadString *locationName,
                 unsigned char *pActAlignBuffer, unsigned char *pActDirectBuffer, int numActuators,
...
class rControllerOutputPoint2
        :
                ...
                public radObject {
public:
    rControllerOutputPoint2(iRIControllerOutputPointCallback2 *handler, IRadString *name,
                            IRadString *type);
...
class rControllerInputPoint2
        :
                ...
                public radObject {
public:
    rControllerInputPoint2(IRefCount *pIObject_Controller, IRadString *name,
                           int inputPointTypeIndex, unsigned int dataOffset, unsigned int mask);
    ...
    void RegisterControllerInputPointCallback(IRadControllerInputPointCallback *pCallback,

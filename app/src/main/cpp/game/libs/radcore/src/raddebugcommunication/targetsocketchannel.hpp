...
public:
    ...
    virtual void
    SendAsync(void *pBuffer, unsigned int numBytes, IRadDbgComChannelSendCallback *callback);

    virtual void
    ReceiveAsync(void *pBuffer, unsigned int numBytes, IRadDbgComChannelReceiveCallback *callback);

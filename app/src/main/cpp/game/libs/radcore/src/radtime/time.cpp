...
void radTimeGetDate( radDate* pDate )
{
    ...
    pDate->m_Year = (unsigned short) timeinfo->tm_year + 1900;
    pDate->m_Month = (unsigned char) timeinfo->tm_mon + 1;
    pDate->m_Day = (unsigned char) timeinfo->tm_mday;
    pDate->m_Hour = (unsigned char) timeinfo->tm_hour;
    pDate->m_Minute = (unsigned char) timeinfo->tm_min;
    pDate->m_Second = (unsigned char) timeinfo->tm_sec;

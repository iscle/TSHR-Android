...
void
rDebugWarningFail_Implementation(const char *condition, const char *filename, unsigned int linenum);

void
rDebugValidFail_Implementation(const char *condition, const char *filename, unsigned int linenum);

...
struct IRadDbgComTargetTable : public IRefCount {
    ...
    //
    virtual void EnumerateTargets(void *context, void (*pEnumerationCallback)(void *context,
...
struct IRadDbgComChannel : public IRefCount {
    ...
    //
    virtual void
    SendAsync(void *pBuffer, unsigned int numBytes, IRadDbgComChannelSendCallback *callback) = 0;
    ...
    //
    virtual void ReceiveAsync(void *pBuffer, unsigned int numBytes,
                              IRadDbgComChannelReceiveCallback *callback) = 0;

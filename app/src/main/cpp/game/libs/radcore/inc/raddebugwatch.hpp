...
struct IRadDebugWatch : public IRefCount {
    ...
    //
    virtual void AddUnsignedInt(unsigned int *pValue, const char *pName, const char *pNameSpace,
                                RADDEBUGWATCH_CALLBACK callback, void *userData, unsigned int min,
                                unsigned int max, bool readonly) = 0;

    virtual void
    AddInt(int *pValue, const char *pName, const char *pNameSpace, RADDEBUGWATCH_CALLBACK callback,
           void *userData, int min, int max, bool readonly) = 0;

    virtual void AddUnsignedShort(unsigned short *pValue, const char *pName, const char *pNameSpace,
                                  RADDEBUGWATCH_CALLBACK callback, void *userData,
                                  unsigned short min, unsigned short max, bool readonly) = 0;

    virtual void AddShort(short *pValue, const char *pName, const char *pNameSpace,
                          RADDEBUGWATCH_CALLBACK callback, void *userData, short min, short max,
                          bool readonly) = 0;

    virtual void AddUnsignedChar(unsigned char *pValue, const char *pName, const char *pNameSpace,
                                 RADDEBUGWATCH_CALLBACK callback, void *userData, unsigned char min,
                                 unsigned char max, bool readonly) = 0;

    virtual void AddChar(char *pValue, const char *pName, const char *pNameSpace,
                         RADDEBUGWATCH_CALLBACK callback, void *userData, char min, char max,
                         bool readonly) = 0;

    //
    // This member is used to add a boolean.
    //
    virtual void AddBoolean(bool *pValue, const char *pName, const char *pNameSpace,
                            RADDEBUGWATCH_CALLBACK callback, void *userData, bool readonly) = 0;

    //
    // This one is used to monitor the value of a float.
    //
    virtual void AddFloat(float *pValue, const char *pName, const char *pNameSpace,
                          RADDEBUGWATCH_CALLBACK callback, void *userData, float min, float max,
                          bool readonly) = 0;
    ...
    //
    virtual void
    AddString(char *pValue, unsigned int stringLength, const char *pName, const char *pNameSpace,
              RADDEBUGWATCH_CALLBACK callback, void *userData, bool readonly) = 0;
    ...
    virtual void AddEnumeration(int *pValue, const EnumerationElement *pEnumerationInfo,
                                unsigned int numberOfElements, const char *pName,
                                const char *pNameSpace, RADDEBUGWATCH_CALLBACK callback,
                                void *userData, bool readonly) = 0;
    ...
    //
    virtual void AddVector(float *pValue, const char *pName, const char *pNameSpace,
                           RADDEBUGWATCH_CALLBACK callback, void *userData, float min, float max,
                           bool readonly) = 0;
    ...
    //
    virtual void
    AddFunction(const char *pName, const char *pNameSpace, RADDEBUGWATCH_CALLBACK callback,
                void *userData) = 0;
    ...
    virtual void
    AssociateFile(const char *pNameSpace, const char *pFilename, FileType fileType) = 0;
...
//
inline void
radDbgWatchAddUnsignedInt(unsigned int *pValue, const char *pName, const char *pNameSpace = NULL,
                          RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                          unsigned int min = 0, unsigned int max = UINT_MAX / 2,
                          bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void radDbgWatchAddInt(int *pValue, const char *pName, const char *pNameSpace = NULL,
                              RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                              int min = INT_MIN / 2, int max = INT_MAX / 2, bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void radDbgWatchAddUnsignedShort(unsigned short *pValue, const char *pName,
                                        const char *pNameSpace = NULL,
                                        RADDEBUGWATCH_CALLBACK callback = NULL,
                                        void *userData = NULL, unsigned short min = 0,
                                        unsigned short max = USHRT_MAX, bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void radDbgWatchAddShort(short *pValue, const char *pName, const char *pNameSpace = NULL,
                                RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                                short min = SHRT_MIN, short max = SHRT_MAX, bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void
radDbgWatchAddUnsignedChar(unsigned char *pValue, const char *pName, const char *pNameSpace = NULL,
                           RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                           unsigned char min = 0, unsigned char max = UCHAR_MAX,
                           bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void radDbgWatchAddChar(char *pValue, const char *pName, const char *pNameSpace = NULL,
                               RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                               char min = CHAR_MIN, char max = CHAR_MAX, bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void radDbgWatchAddBoolean(bool *pValue, const char *pName, const char *pNameSpace = NULL,
                                  RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                                  bool readonly = false) {
#ifdef DEBUGWATCH
...
inline void radDbgWatchAddFloat(float *pValue, const char *pName, const char *pNameSpace = NULL,
                                RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                                float min = 0.0f, float max = 1.0f, bool readonly = false) {
#ifdef DEBUGWATCH
...
//
inline void radDbgWatchAddString(char *pValue, unsigned int stringLength, const char *pName,
                                 const char *pNameSpace = NULL,
                                 RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                                 bool readonly = false) {
#ifdef DEBUGWATCH
...
//
inline void
radDbgWatchAddEnumeration(int *pValue, const IRadDebugWatch::EnumerationElement *pEnumerationInfo,
                          unsigned int numberOfElements, const char *pName,
                          const char *pNameSpace = NULL, RADDEBUGWATCH_CALLBACK callback = NULL,
                          void *userData = NULL, bool readonly = false) {
#ifdef DEBUGWATCH
    radDebugWatchGet()->AddEnumeration(pValue, pEnumerationInfo, numberOfElements, pName, pNameSpace, callback, userData, readonly);
#else
    (void) pValue;
    (void) pEnumerationInfo;
...
// three consectutive floats, x, y , z 
//
inline void radDbgWatchAddVector(float *pValue, const char *pName, const char *pNameSpace = NULL,
                                 RADDEBUGWATCH_CALLBACK callback = NULL, void *userData = NULL,
                                 float min = 0.0f, float max = 1.0f, bool readonly = false) {
#ifdef DEBUGWATCH
...
//
inline void
radDbgWatchAddFunction(const char *pName, RADDEBUGWATCH_CALLBACK callback, void *userData = NULL,
                       const char *pNameSpace = NULL) {
#ifdef DEBUGWATCH
...
//
inline void radDbgWatchAssociateFile(const char *pNameSpace, const char *pFilename,
                                     IRadDebugWatch::FileType fileType = IRadDebugWatch::FileXml) {
#ifdef DEBUGWATCH
